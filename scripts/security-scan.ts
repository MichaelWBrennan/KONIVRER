...
const securityChecks: SecurityCheck[] = [
  ...
  },
  {
    ...
    status: "passed",
    details: "No insecure deserialization vulnerabilities detected",
  },
  {
    name: "Using components with known vulnerabilities",
    status: "passed",
    details: "All components are up to date",
  },
  {
    name: "Insufficient logging & monitoring",
    status: "passed",
    details: "Logging and monitoring are properly configured",
  },
];
