...
const STATIC_ASSETS = [
  ...
  // Add essential mobile-first CSS and JS (will be generated by build)
];

// Mobile-optimized caching strategies
const CACHE_STRATEGIES = {
  // Critical resources - Cache First (fastest for mobile)
  CACHE_FIRST: 'cache-first',
  // API calls - Network First with cache fallback
  NETWORK_FIRST: 'network-first',
  // Images - Cache First with size limits for mobile storage
  IMAGES: 'cache-first-images',
  // Static assets - Stale While Revalidate for balance
  STALE_WHILE_REVALIDATE: 'stale-while-revalidate'
};

// Mobile-friendly cache limits
const CACHE_LIMITS = {
  IMAGES: 50, // Limit image cache for mobile storage
  DYNAMIC: 100, // API responses and dynamic content
