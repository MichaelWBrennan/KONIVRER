    ...
    try {
        ...
        for (const record of records) {
            ...
            const dynamoParams = {
                ...
                Item: {
                    configKey: `billing:${billingEvent.metadata.transactionId || Date.now()}`,
                    timestamp: Date.now(),
                    data: billingEvent,
    ...
    try {
        ...
        switch (type) {
            ...
            case 'customer.subscription.updated':
                return {
                    ...baseEvent,
                    billingEventType: type === 'customer.subscription.created' ? 'subscription_created' : 'subscription_updated',
            ...
            case 'customer.updated':
                return {
                    ...baseEvent,
                    billingEventType: type === 'customer.created' ? 'customer_created' : 'customer_updated',
