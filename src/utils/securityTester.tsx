  ...
  // Session Security Tests
  {
    ...
    testFunction: async () => {
      ...
      const hasSecureSession =
        sessionStorage.getItem('konivrer_session') !== null ||
      ...
      return {
        ...
        message: hasSecureSession
          ? 'Insecure session storage detected'
          : 'Session storage secure',
        details:
          'Session tokens should not be stored in plain localStorage/sessionStorage',
        timeTaken: Date.now() - startTime,
      };
    },
  },
    ...
    testFunction: async () => {
      ...
      return {
        ...
        details: hasCSP
          ...
          : 'Consider adding CSP for XSS protection',
        timeTaken: Date.now() - startTime,
      };
    },
  },
...
const SecurityTester: React.FC = () => {
  ...
  const runTest = useCallback(
    async (test: SecurityTest): Promise<SecurityTest> => {
  ...
  return (
    ...
    >
      <div style={{ marginBottom: '20px' }}>
        <h3
          style={{ color: '#d4af37', margin: '0 0 10px 0', fontSize: '18px' }}
        >
        ...
        >
          ...
          >
            <div
              style={{ color: '#2ed573', fontSize: '16px', fontWeight: 'bold' }}
            >
              {stats.passed}
            </div>
          ...
          >
            <div
              style={{ color: '#ff4757', fontSize: '16px', fontWeight: 'bold' }}
            >
              {stats.failed}
            </div>
          ...
          >
            <div
              style={{ color: '#ffa502', fontSize: '16px', fontWeight: 'bold' }}
            >
              {stats.running}
            </div>
          ...
          >
            <div
              style={{ color: '#888', fontSize: '16px', fontWeight: 'bold' }}
            >
              {stats.pending}
            </div>
        ...
        {isRunning && (
          <div style={{ marginBottom: '15px' }}>
            ...
            {currentTest && (
              <div
                style={{ color: '#ccc', fontSize: '12px', marginTop: '5px' }}
              >
                  ...
                  {test.result && (
                    <>
                      <div
                        style={{
                          color:
                            test.status === 'passed' ? '#2ed573' : '#ff4757',
                          fontSize: '12px',
                          marginBottom: '2px',
                        }}
                      >
