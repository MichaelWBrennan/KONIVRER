  ...
  const CardComponent: React.FC<{
    ...
    return (
      <motion.div
        ...
        whileHover={{
          scale: location === 'hand' ? 1.05 : 1.02,
          y: location === 'hand' ? -10 : 0,
        }}
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h3
            style={{ margin: '0 0 12px 0', color: '#dc2626', fontSize: '16px' }}
          >
            Opponent Board
          </h3>
        ...
        >
          <h3
            style={{ margin: '0 0 12px 0', color: '#22c55e', fontSize: '16px' }}
          >
            Your Board
          </h3>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
        ...
        >
          <h3
            style={{ margin: '0 0 12px 0', color: '#3b82f6', fontSize: '16px' }}
          >
            Your Hand
          </h3>
          <div
          ...
          {gameState.selectedCard && (
            ...
            >
              Selected: {gameState.selectedCard.name} • Click again to play •
...
const getCardColor = (card: Card, darker = false) => {
  ...
  return (
    colors[element as keyof typeof colors] || (darker ? '#4b5563' : '#6b7280')
  );
};
