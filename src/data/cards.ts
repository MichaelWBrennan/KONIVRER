...
function getCardElements(name: string): string[] {
  const elements: string[] : any : any : any = [];
...
function getCardAbilities(name: string): string[] {
  const abilities: string[] : any : any : any = [];
...
const fallbackCardDatabase: Card[] : any : any : any = cardNames.map((name, index) => {
  const elements : any : any : any = getCardElements(name);
  const lesserType : any : any : any = getCardLesserType(name);
  const rarity : any : any : any = getCardRarity(name);
  const abilities : any : any : any = getCardAbilities(name);
...
export function getCardDatabase(): Card[] {
  ...
  const generatedData : any : any : any = cardDataGenerator.loadCardData();
...
export const cardDatabase : any : any : any = getCardDatabase();
