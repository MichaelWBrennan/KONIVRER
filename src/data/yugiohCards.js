...
export const yugiohCards = {
  ...
  20721928: {
    ...
    defense: 1400,
    cardType: "Normal Monster",
    description: "An Elemental HERO with the power of lightning. He uses his electric powers to shock his enemies.",
    rarity: "Common",
  ...
  21844576: {
    ...
    defense: 1000,
    cardType: "Normal Monster",
    description: "A winged Elemental HERO who wheels through the sky and manipulates the wind. His signature move, Featherbreak, gives villainy a blow from above.",
    rarity: "Common",
    archetype: "Elemental HERO",
    image: "/api/placeholder/200/290"
  },
  79979666: {
    ...
    defense: 800,
    cardType: "Normal Monster",
    description: "A flame manipulator who is an Elemental HERO. She can launch fireballs and fire blasts at her enemies.",
    rarity: "Common",
    archetype: "Elemental HERO",
    image: "/api/placeholder/200/290"
  },
  ...
  1845204: {
    ...
    type: "Spell",
    cardType: "Normal Spell",
    description: "Pay 1000 LP; Special Summon 1 Level 5 or lower Fusion Monster from your Extra Deck, but it cannot attack, also destroy it during the End Phase.",
    rarity: "Rare",
    image: "/api/placeholder/200/290"
  },
  ...
  83764718: {
    ...
    description: "When a monster(s) would be Summoned, OR a Spell/Trap Card is activated: Pay half your LP; negate the Summon or activation, and if you do, destroy that card.",
    rarity: "Ultra Rare",
    image: "/api/placeholder/200/290"
  },
  ...
  23995346: {
    ...
    rarity: "Ultra Rare",
    archetype: "Blue-Eyes",
    fusionMaterial: ["Blue-Eyes White Dragon", "Blue-Eyes White Dragon", "Blue-Eyes White Dragon"],
    image: "/api/placeholder/200/290"
  },
  35809262: {
    id: 35809262,
  ...
  77585513: {
    ...
    defense: 1700,
    cardType: "Effect Monster",
    description: "This card gains 300 ATK for every \"Dark Magician\" or \"Magician of Black Chaos\" in the GY.",
    rarity: "Ultra Rare",
    archetype: "Dark Magician",
    image: "/api/placeholder/200/290"
  },
  26412047: {
    ...
    defense: 1200,
    cardType: "Normal Monster",
    description: "A fiend with dark powers for confusing enemies. Among the Fiend-Type monsters, this monster boasts considerable force.",
    rarity: "Rare",
    image: "/api/placeholder/200/290"
  },
  70781052: {
...
export const getCardByName = (name) => {
  return Object.values(yugiohCards).find(card => 
    card.name.toLowerCase() === name.toLowerCase()
  ) || null;
};

export const getCardsByArchetype = (archetype) => {
  return Object.values(yugiohCards).filter(card => 
