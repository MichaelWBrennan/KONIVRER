...
globalStyle("html, body, input, textarea, button", {
...
globalStyle(".card-details", {
  fontSize: "0.9rem",
  color: "var(--text-secondary)",
});

globalStyle(".pagination-info", {
  color: "var(--text-secondary)",
  textAlign: "center",
  margin: "0.5rem 0",
});
...
// Anomalies center
globalStyle(".anomalies-view .anomaly-header", {
  display: "flex",
  alignItems: "center",
  justifyContent: "space-between",
  marginBottom: "0.5rem",
...
globalStyle(".anomalies-list", {
  display: "grid",
  gap: "0.75rem",
  marginTop: "0.5rem",
});

globalStyle(".anomaly-item", {
  background: "rgba(255,255,255,0.02)",
  border: "1px solid rgba(255,255,255,0.06)",
  borderRadius: 12,
  padding: "1rem",
...
globalStyle(".anomaly-item .anomaly-header", {
  display: "flex",
  gap: "0.5rem",
  alignItems: "center",
  justifyContent: "space-between",
...
globalStyle(".severity.critical", {
  borderColor: "rgba(239,68,68,0.35)",
  color: "#ef4444",
});

globalStyle(".severity.medium", {
  borderColor: "rgba(245,158,11,0.35)",
  color: "#f59e0b",
});

globalStyle(".anomaly-description", {
  color: "var(--text-secondary)",
  marginBottom: "0.5rem",
});

globalStyle(".anomaly-details", {
  display: "flex",
  gap: "1rem",
  color: "var(--text-secondary)",
});

globalStyle(".anomaly-actions", {
  display: "flex",
  gap: "0.5rem",
  marginTop: "0.5rem",
});
...
globalStyle('[data-contrast="high"] .card-item', {
  boxShadow: "none",
