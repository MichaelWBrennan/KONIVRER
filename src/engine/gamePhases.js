 ...
 * @returns {Object} Updated game state
 */
export function processStartPhase(gameState) {
  const activePlayer = gameState.activePlayer;
 ...
 * @returns {Object} Updated game state
 */
export function processMainPhase(gameState) {
  const activePlayer = gameState.activePlayer;
 ...
 * @returns {Object} Updated game state
 */
export function processCombatPhase(gameState) {
  // Update phase
 ...
 * @returns {Object} Updated game state
 */
export function processPostCombatMainPhase(gameState) {
  const activePlayer = gameState.activePlayer;
 ...
 * @returns {Object} Updated game state
 */
export function processRefreshPhase(gameState) {
  const activePlayer = gameState.activePlayer;
 ...
 * @returns {Object} Updated game state
 */
export function transitionToPhase(gameState, nextPhase) {
 ...
 */
function isValidPhaseTransition(currentPhase, nextPhase) {
