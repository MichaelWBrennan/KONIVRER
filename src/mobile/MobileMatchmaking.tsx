        ...
        <div className="flex items-center space-x-3"></div>
          {pendingResults.length > 0 && (
            <div className="relative"></div>
              <RefreshCw className="w-5 h-5 text-blue-500" /></RefreshCw>
          ...
          <div className="relative"></div>
            <Bell className="w-5 h-5 text-gray-500" /></Bell>
      ...
      <div className="p-4"></div>
        ...
        <div className="mb-6"></div>
          <div className="grid grid-cols-2 gap-3"></div>
            ...
            ></button>
              {searching ? (
                <RefreshCw className="w-6 h-6 mb-2 animate-spin" /></RefreshCw>
              ) : (
                <Zap className="w-6 h-6 mb-2" /></Zap>
              )}
            ...
            <button className="bg-white text-gray-800 rounded-lg p-4 flex flex-col items-center justify-center shadow-sm border border-gray-200"></button>
              <Calendar className="w-6 h-6 mb-2 text-gray-500" /></Calendar>
              <span className="font-medium">Tournaments</span>
            </button>

            <button className="bg-white text-gray-800 rounded-lg p-4 flex flex-col items-center justify-center shadow-sm border border-gray-200"></button>
              <Users className="w-6 h-6 mb-2 text-gray-500" /></Users>
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden mb-6"></div>
          ...
          {loading ? (
            <div className="p-8 text-center"></div>
              <RefreshCw className="animate-spin h-8 w-8 text-gray-400 mx-auto mb-4" /></RefreshCw>
              <p className="text-gray-500">Loading matches...</p>
            </div>
          ) : availableMatches.length === 0 ? (
            <div className="p-8 text-center"></div>
              <Users className="h-8 w-8 text-gray-300 mx-auto mb-4" /></Users>
            ...
            <div className="bg-white rounded-lg p-6 max-w-sm w-full"></div>
              <div className="text-center"></div>
                <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4"></div>
                  <Mic className="w-8 h-8 text-blue-600" /></Mic>
                </div>
