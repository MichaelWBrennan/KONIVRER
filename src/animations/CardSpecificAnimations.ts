 ...
 */
export function getCardSpecificAnimations(() => {
 ...
 */
function registerCardAnimation() {
...
registerCardAnimation('fire-elemental', {
    onPlay(element: any, timeline: any, settings: any) {,
    ...
    ``
      ...
      particleContainer.style.top = `${elementRect.top`
  }px`;```
  ...
  onAttack(element: any, targetElement: any, timeline: any, settings: any) {,
  ...
  onAbility(element: any, timeline: any, settings: any, abilityIndex: any, targets: any) {,
    // Fire ability effect
    timeline
      .to(element, {
    duration: 0.3,
