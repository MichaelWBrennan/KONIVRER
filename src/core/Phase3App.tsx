...
const CardsPage = () => {
  ...
  const allCards: Card[] = [
    ...
    { id: '4', name: 'Healing Standard', cost: 2, type: 'Flag', description: 'A sacred banner that continuously heals nearby familiars.', rarity: 'Common', elements: ['Water', 'Spirit'], keywords: ['Healing', 'Persistent'], artist: 'David Kim' },
    ...
    { id: '7', name: 'Phoenix Rising', cost: 7, type: 'Familiar', description: 'A legendary bird that rises from ashes.', rarity: 'Legendary', elements: ['Fire', 'Spirit'], keywords: ['Flying', 'Rebirth'], strength: 5, artist: 'Elena Vasquez' },
    ...
    { id: '12', name: 'Shadow Wraith', cost: 3, type: 'Familiar', description: 'A ghostly creature that phases through defenses.', rarity: 'Rare', elements: ['Nether'], keywords: ['Stealth', 'Ethereal'], strength: 2, artist: 'Viktor Dark' }
  ];
