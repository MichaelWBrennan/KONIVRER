      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <h3 style={{ marginBottom: '15px', color: '#fff' }}>⭐ Deck Building</h3>
            <p style={{ color: '#ccc', lineHeight: '1.6' }}>
              Create powerful decks using mystical cards with unique abilities and strategic combinations.
            </p>
          </div>
          <div style={{
            background: '#1a1a1a',
            ...
            <h3 style={{ marginBottom: '15px', color: '#fff' }}>⭐ Card Database</h3>
            <p style={{ color: '#ccc', lineHeight: '1.6' }}>
              Explore our comprehensive collection of cards with detailed stats and mystical artwork.
            </p>
          </div>
          <div style={{
            background: '#1a1a1a',
            ...
            <h3 style={{ marginBottom: '15px', color: '#fff' }}>⭐ Game Rules</h3>
            <p style={{ color: '#ccc', lineHeight: '1.6' }}>
              Learn the mystical rules and strategies that govern the world of KONIVRER.
            </p>
          </div>
        </div>
        ...
        <div style={{
          ...
          <h2 style={{ marginBottom: '20px', color: '#fff' }}>✨ About KONIVRER</h2>
          <p style={{ color: '#ccc', lineHeight: '1.8', fontSize: '1.1rem' }}>
            Enter a world where mystical forces collide and strategic minds prevail. 
            KONIVRER combines the depth of traditional trading card games with 
            esoteric themes and modern digital gameplay.
          </p>
        </div>
      </div>
    </div>
...
const DeckBuilderPage: React.FC = () => (
  <div style={{ padding: '40px', background: '#0f0f0f', color: '#fff', minHeight: '100vh' }}>
    <h1>⭐ Deck Builder</h1>
