...
export const konivrverRules: KonivrverRule[]     : any : any = [
  {
    section: "I",
    title: "Introduction",
...
export const keywordAbilities: Record<KonivrverKeywordAbility, string>     : any : any = {
...
export const phaseDescriptions: Record<string, string>     : any : any = {
...
export function searchRules(query: string, options?: {
  ...
  const { exactMatch     : any : any = false, caseSensitive = false, searchKeywords = true } = options || {};
...
export function searchWithSynonyms(query: string): KonivrverRule[] {
  const synonyms: Record<string, string[]>     : any : any = {
