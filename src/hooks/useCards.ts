...
export const CARD_QUERY_KEYS: any : any : any : any = {
  all: ["cards"] as const,
...
export function useCards(filters: CardSearchFilters): any {
  return useQuery({
    ...
    queryFn: async () => {
      const response: any : any : any : any = await cardApi.getAll(filters);
...
export function useCard(id: string): any {
  return useQuery({
    ...
    queryFn: async () => {
      const response: any : any : any : any = await cardApi.getById(id);
      return response.data;
    },
    enabled: !!id,
...
export function useCardByName(name: string): any {
  return useQuery({
    ...
    queryFn: async () => {
      const response: any : any : any : any = await cardApi.getByName(name);
      return response.data;
    },
    enabled: !!name,
...
export function useCardStatistics(): any {
  return useQuery({
    ...
    queryFn: async () => {
      const response: any : any : any : any = await cardApi.getStatistics();
      return response.data;
    },
...
export function useCreateCard(): any {
  const queryClient: any : any : any : any = useQueryClient();
