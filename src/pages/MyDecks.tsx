...
const mockUserDecks: DeckWithActions[] : any : any : any : any = [];

export const MyDecks: React.FC : any : any : any : any = () => {
  const [searchTerm, setSearchTerm] : any : any : any : any = useState('');
  const [sortBy, setSortBy] : any : any : any : any = useState<'name' | 'created' | 'lastPlayed' | 'winRate'>('lastPlayed');
  const [filterBy, setFilterBy] : any : any : any : any = useState<'all' | 'public' | 'private'>('all');
  ...
  const filteredDecks : any : any : any : any = useMemo(() => {
    let decks = mockUserDecks.filter(deck => {
      ...
      const matchesVisibility : any : any : any : any = filterBy === 'all' || 
  ...
  const handleEditDeck : any : any : any : any = (deck: Deck) => {
  ...
  const handleToggleVisibility : any : any : any : any = (deckId: string) => {
  ...
  const handleDeleteDeck : any : any : any : any = (deckId: string) => {
