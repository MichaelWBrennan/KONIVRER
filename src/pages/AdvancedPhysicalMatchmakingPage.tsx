      ...
      <div className="fixed inset-0 bg-gradient-to-b from-gray-900 to-black flex flex-col items-center justify-center"></div>
        ...
        ></motion>
          ...
          <div className="text-gray-500 flex items-center justify-center"></div>
            <Loader className="w-5 h-5 mr-2 animate-spin" /></Loader>
    ...
    ></div>
      ...
      <div className="lg:hidden flex items-center justify-between p-4 border-b border-gray-700"></div>
        ...
        <div className="flex items-center"></div>
          <Sparkles className="w-6 h-6 text-amber-400 mr-2" /></Sparkles>
          ...
          ></motion>
            ...
            <div className="absolute inset-y-0 left-0 w-64 bg-gray-900 shadow-lg p-4"></div>
              ...
              <nav className="space-y-1"></nav>
                ...
                >
                  <LayoutDashboard className="w-5 h-5 mr-3" /></LayoutDashboard>
                  <span>Dashboard</span>
                </button>
                <button
                  onClick={() => {
                ...
                >
                  <Trophy className="w-5 h-5 mr-3" /></Trophy>
                ...
                >
                  <Layers className="w-5 h-5 mr-3" /></Layers>
                ...
                >
                  <Swords className="w-5 h-5 mr-3" /></Swords>
              ...
              <div className="absolute bottom-4 left-4 right-4 space-y-1"></div>
                ...
                <button
                  ...
                  className="w-full flex items-center px-3 py-0 whitespace-nowrap rounded-lg text-gray-300 hover:bg-gray-800"
                >
                  <HelpCircle className="w-5 h-5 mr-3" /></HelpCircle>
                  <span>Help</span>
                </button>
              </div>
            </div>
      ...
      <div className="flex h-screen overflow-hidden"></div>
        {/* Sidebar */}
        <aside
          className={`hidden lg:block bg-gray-900 ${sidebarOpen ? 'w-64' : 'w-20'} transition-all duration-300 border-r border-gray-700 relative`}
        ></aside>
          <div
            className={`p-4 flex ${sidebarOpen ? 'justify-between' : 'justify-center'} items-center border-b border-gray-700`}
          ></div>
            {sidebarOpen ? (
              <>
                <div className="flex items-center"></div>
                ...
                >
                  <ChevronUp className="w-5 h-5 transform -rotate-90" /></ChevronUp>
                </button>
              </>
            ) : (
              <button
                ...
                className="p-1 rounded-lg text-gray-400 hover:bg-gray-800"
              >
                <Sparkles className="w-6 h-6 text-amber-400" /></Sparkles>
              </button>
            )}
          </div>
          <nav className="p-4 space-y-1"></nav>
            ...
            >
              <LayoutDashboard className="w-5 h-5 min-w-[20px]" /></LayoutDashboard>
            ...
            >
              <Trophy className="w-5 h-5 min-w-[20px]" /></Trophy>
            ...
            >
              <Layers className="w-5 h-5 min-w-[20px]" /></Layers>
            ...
            >
              <Swords className="w-5 h-5 min-w-[20px]" /></Swords>
            ...
            >
              <Users className="w-5 h-5 min-w-[20px]" /></Users>
          ...
          <div className="absolute bottom-4 left-4 right-4 space-y-1"></div>
            <button
              ...
              className="w-full flex items-center px-3 py-0 whitespace-nowrap rounded-lg text-gray-300 hover:bg-gray-800"
            >
              <Settings className="w-5 h-5 min-w-[20px]" /></Settings>
            ...
            <button
              ...
              className="w-full flex items-center px-3 py-0 whitespace-nowrap rounded-lg text-gray-300 hover:bg-gray-800"
            >
              <HelpCircle className="w-5 h-5 min-w-[20px]" /></HelpCircle>
          ...
          <header className="hidden lg:flex items-center justify-between p-4 border-b border-gray-700"></header>
            ...
            <div className="flex items-center space-x-4"></div>
              <div className="relative"></div>
                ...
                />
                <Search className="w-5 h-5 text-gray-400 absolute left-3 top-2.5" /></Search>
              </div>
              <div className="relative"></div>
                <button
                  onClick={() => setShowNotifications(!showNotifications)}
          ...
          <div className="flex-1 overflow-auto p-4"></div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"></div>
                    {filteredTournaments.length > 0 ? (
                        ...
                        >
                          ...
                          <div className="space-y-2 mb-4"></div>
                            <div className="flex items-center text-sm text-gray-300"></div>
                              <Calendar className="w-4 h-4 mr-2 text-gray-400" /></Calendar>
                              <span></span>
                                {new Date(
                            ...
                            <div className="flex items-center text-sm text-gray-300"></div>
                              <Users className="w-4 h-4 mr-2 text-gray-400" /></Users>
                              <span></span>
                                {tournament.players?.length || 0} Players
                              </span>
                            </div>
                            <div className="flex items-center text-sm text-gray-300"></div>
                              <Trophy className="w-4 h-4 mr-2 text-gray-400" /></Trophy>
                      ...
                      <div className="col-span-full text-center py-12"></div>
                        <Trophy className="w-16 h-16 mx-auto mb-4 text-gray-600" /></Trophy>
            ...
            {activeTab === 'players' && (
              <div className="text-center py-12"></div>
                <Users className="w-16 h-16 mx-auto mb-4 text-gray-600" /></Users>
              ...
              <div className="space-y-6"></div>
                <div></div>
                  <div className="grid grid-cols-3 gap-3"></div>
                    ...
                    >
                      <Scroll className="w-6 h-6 mx-auto mb-2 text-amber-400" /></Scroll>
                    ...
                    >
                      <Zap className="w-6 h-6 mx-auto mb-2 text-blue-400" /></Zap>
                    ...
                    >
                      <Sparkles className="w-6 h-6 mx-auto mb-2 text-purple-400" /></Sparkles>
                  ...
                  <div className="space-y-3"></div>
                    <div className="flex items-center justify-between"></div>
                      ...
                      <div className="relative inline-block w-10 mr-2 align-middle select-none"></div>
                        ...
                        ></label>
                          <span
                            className={`block h-6 w-6 rounded-full bg-amber-500 transform transition-transform duration-200 ease-in-out ${true ? 'translate-x-4' : 'translate-x-0'}`}
                          ></span>
                        </label>
                      </div>
                    </div>
