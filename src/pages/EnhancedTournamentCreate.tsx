  ...
  const renderTemplateSelection = () => (
    <div className="space-y-6"></div>
      <div className="bg-white rounded-lg shadow-md p-6"></div>
        ...
        <TournamentTemplates onSelectTemplate={handleTemplateSelect} /></TournamentTemplates>
        ...
        <div className="space-y-4"></div>
          ...
          <div className="p-4 bg-blue-50 rounded-lg mt-4"></div>
            <div className="flex items-center mb-2"></div>
              <Info size={16} className="text-blue-600 mr-2" /></Info>
      ...
      {error && (
        <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-6 flex items-center justify-between"></div>
          <div className="flex items-center"></div>
            <AlertCircle className="mr-2" size={20} /></AlertCircle>
            <span>{error}</span>
          </div>
          <button 
