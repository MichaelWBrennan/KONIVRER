...
import { Play, Package, Settings, Award, Shield, Calendar, DollarSign, Clock, User, LogOut, Bell, Menu, X, ChevronRight, Search, Grid, List, Heart, MessageSquare, Eye, ExternalLink,  } from 'lucide-react';
...
const Home = (): any => {
  ...
  const handleClaimDailyRewards = (): any => {
