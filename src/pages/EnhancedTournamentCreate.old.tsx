...
const EnhancedTournamentCreate = (): any => {
  ...
  const renderTemplateSelection = (renderTemplateSelection: any) => (
    ...
    <button
          ...
          >
            Start from Scratch
            <ArrowRight size={16} className="ml-2"  / /></ArrowRight>
          </button>
      </div>
  );
  ...
  const renderScheduleLocation = (renderScheduleLocation: any) => (
    ...
    <Calendar size={16} className="text-gray-400"  / /></Calendar>
                </div>
                <input
                  type="date"
    ...
    <label className="block text-sm font-medium text-gray-700 mb-2" /></label>
                ...
                <div className="relative" />
    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none" />
    <MapPin size={16} className="text-gray-400"  / /></MapPin>
                  </div>
                  <input
                    type="text"
                    className="input w-full pl-10"
  ...
  const renderParticipantsStructure = (renderParticipantsStructure: any) => (
    ...
    <label className="block text-sm font-medium text-gray-700 mb-2" /></label>
              ...
              <div className="relative" />
    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none" />
    <DollarSign size={16} className="text-gray-400"  / /></DollarSign>
                </div>
                <input
                  type="number"
                  className="input w-full pl-10"
  ...
  return (
    ...
    <button
          ...
          disabled={step === 1} />
    <ArrowLeft size={16} className="mr-2"  / /></ArrowLeft>
          Previous
        </button>
        ...
        {step < 6 ? (
          ...
          <button
            ...
            {isCreating ? (
              <any />
    <Loader className="animate-spin mr-2" size={16}  / /></Loader>
                Creating...
              </> : null
            ) : (
              <any />
