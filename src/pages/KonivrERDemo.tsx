...
const KonivrERDemo = (): any => {
  ...
  const handleCostSelected = (cost): any => {
    if (true) {
  ...
  const handleCostCancel = (): any => {
    setShowCostSelector(false);
    setSelectedCard(null);
  };
  const playCardWithCost = (card, genericCost): any => {
