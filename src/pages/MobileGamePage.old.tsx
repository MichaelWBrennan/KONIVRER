...
const MobileGamePage = (): any => {
  ...
  const [gameStatus, setGameStatus] = useState(false) // setup, playing, ended
  ...
  const [gameLog, setGameLog] = useState(false)
  ...
  return (
    ...
    <div className="mobile-opponent-info" /></div> : null
