...
import { Database, Search, Filter, Bot, ChevronRight, ChevronLeft } from 'lucide-react';
          ...
          <div className="bg-card rounded-lg p-6">
            <div className="flex items-center gap-4 mb-6">
              ...
              >
                ...
                AI Assistant
                {showAIAssistant ? <ChevronLeft className="w-4 h-4" /> : <ChevronRight className="w-4 h-4" />}
              </button>
            </div>
            ...
            <div className="p-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-secondary text-sm">Get card recommendations and insights</p>
                </div>
              </div>
              <AIAssistant />
            </div>
