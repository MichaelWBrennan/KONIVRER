...
const UnifiedHome: React.FC<UnifiedHomeProps> = ({ variant = 'standard' }) => {
  ...
  const renderMobileHome = () => {
    ...
    <div className="text-xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent" /></div>
              KONIVRER
            </div>
    ...
    <div className="absolute top-2 left-2 bg-blue-600 text-xs px-2 py-1 rounded-full" /></div>
                      {post.category}
                    </div>
                  </div>
                  <div className="p-3" />
  ...
  const renderSimpleHome = () => {
    ...
    <Link to="/play" className="bg-blue-600 hover:bg-blue-500 px-6 py-3 rounded-lg font-medium text-lg transition-colors" /></Link>
                Play Now
              </Link>
              <Link to="/cards" className="bg-gray-700 hover:bg-gray-600 px-6 py-3 rounded-lg font-medium text-lg transition-colors" /></Link>
                Browse Cards
              </Link>
            </div>
          </div>
    ...
    <div className="text-2xl font-bold mb-2">KONIVRER</div>
                <p className="text-gray-400 max-w-md" /></p>
                  The ultimate deck building and card database for the KONIVRER trading card game.
                </p>
              </div>
  ...
  const renderStandardHome = () => {
    ...
    <span className="bg-blue-600 text-white px-2 py-0.5 rounded-full mr-2" /></span>
                        {post.category}
                      </span>
                      <span>{post.type}</span>
                    ...
                    <h3 className="text-lg font-medium mb-2 group-hover:text-blue-400 transition-colors" /></h3>
                      {post.title}
                    </h3>
                    ...
                    <div className="flex justify-between items-center" />
    <div className="flex items-center" />
    <div className="w-6 h-6 rounded-full bg-gray-600 mr-2" />
    <div />
  ...
  const renderGoldenHome = () => {
    ...
    <h1 className="text-4xl md:text-6xl font-bold mb-4 bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-600 bg-clip-text text-transparent" /></h1>
              Welcome to KONIVRER
            </h1>
    ...
    <Award className="text-black" size={24}  / /></Award>
                    </div>
                    <div />
