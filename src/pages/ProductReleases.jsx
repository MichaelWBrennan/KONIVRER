  ...
  const sampleProducts = [
    {
      ...
      description:
        'Set sail for adventure in the latest KONIVRER expansion featuring pirate heroes, naval combat, and treasure hunting mechanics.',
      features: [
        '3 New Pirate Heroes',
        '150+ New Cards',
        'Naval Combat System',
    ...
    },
    {
      ...
      description:
        'Perfect introduction to KONIVRER featuring the Shadow Realm theme with pre-constructed decks and tutorial materials.',
      features: [
        '2 Pre-built Decks',
        'Tutorial Guide',
        'Shadow Realm Heroes',
    ...
    },
    {
      ...
      description:
        'Deluxe collection featuring foil versions of the most powerful elemental cards and exclusive artwork.',
      features: [
    ...
    },
    {
      ...
      description:
        'Official tournament pack with balanced cards for competitive play and exclusive tournament promos.',
      features: [
    ...
    },
    {
      ...
      description:
        "Ultra-premium set featuring legendary heroes from KONIVRER's ancient past with unique mechanics and stunning art.",
      features: [
        'Mythic Rarity Cards',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300 text-lg max-w-2xl mx-auto">
            Stay up to date with the latest KONIVRER products, expansions, and
            special releases. From starter decks to premium collections,
            discover what's new in the world of KONIVRER.
          </p>
        </div>
                  ...
                  >
                    <div className="flex justify-between items-start mb-4">
                      <div className="flex items-center space-x-2">
                        <span
                          className={`px-3 py-1 rounded-full text-sm border ${statusBadge.class}`}
                        >
                          {statusBadge.label}
                        </span>
        ...
        <div className="mt-12 bg-gradient-to-r from-purple-500/20 to-blue-500/20 rounded-xl p-8 border border-purple-500/30">
          <div className="text-center">
            ...
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
              Be the first to know about new product releases, pre-orders, and
              exclusive offers. Subscribe to our newsletter for the latest
              KONIVRER updates.
            </p>
