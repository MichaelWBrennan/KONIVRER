...
const StreamlinedGamePlatform = (): any => {
  ...
  const [activeSearchCriteria, setActiveSearchCriteria] = useState(false)
  ...
  const renderSectionContent = (): any => {
    ...
    setSearchResults(null)
            ...
            <CardDatabase
              ...
              showSearchInterface={true}  / /></CardDatabase>
          </div>
        );
      case 'deck-workshop':
        return() {
  ...
  return (
    ...
    isActive
                      ? 'bg-gradient-to-br ' +
                        section.color +`
                        ' text-white shadow-lg scale-105'` : null`
    ...
    <div /></div>``
                  ...
                  {isActive && (
                    <motion.div
                      ...
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                      transition={{ duration: 0.3 }}  / /></motion>
                  )}
                </motion.button>
              )
            })}
