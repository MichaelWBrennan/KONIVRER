    ...
    champions: [
      {
        ...
        majorWins: 8,
        description:
          'Dominated the 2024 season with innovative storm-based strategies and flawless execution.',
        achievements: [
          'World Champion 2024',
      ...
      },
      {
        ...
        majorWins: 12,
        description:
          'Legendary craftsman who revolutionized elemental deck building and tournament strategy.',
        achievements: [
          'World Champion 2023',
      ...
      },
      {
        ...
        majorWins: 15,
        description:
          'Master of shadow techniques whose precision and tactical brilliance set new standards.',
        achievements: [
          'World Champion 2022',
    ...
    hallOfFame: [
      {
        ...
        worldTitles: 2,
        description:
          'Pioneer of competitive KONIVRER who established many foundational strategies still used today.',
        legacy:
          "Created the 'Dragonheart Meta' that dominated early competitive play.",
      },
      {
        id: 2,
        ...
        worldTitles: 1,
        description:
          'Innovative deck builder whose creative approaches changed how players think about card synergies.',
        legacy:
          "Developed the 'Moonweave Combo' archetype that influenced an entire generation of players.",
      },
    ],
    records: [
      {
      ...
      },
      {
        ...
        year: '2022-2024',
        description:
          'Most regional championship titles won by a single player.',
      },
    ],
    achievements: [
      {
      ...
      },
      {
        title: 'Grand Slam',
        description:
          'Win World Championship, Regional Championship, and National Championship in the same year',
      ...
      },
      {
        ...
        holders: [
          'Viktor Dragonheart (2021)',
          'Sarah Moonweaver (2022)',
          'Elena Nightfall (2022)',
        ],
        rarity: 'Rare',
      },
      {
              ...
              <div>
                ...
                <div className="flex items-center space-x-2">
                  <span className="text-2xl">
                    {getCountryFlag(champion.country)}
                  </span>
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <span
                  className={`bg-gradient-to-r ${getRarityColor(achievement.rarity)} bg-clip-text text-transparent font-semibold`}
                >
                  {achievement.rarity}
                </span>
              </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300 text-lg max-w-2xl mx-auto">
            Celebrating the greatest champions, record holders, and legendary
            players who have shaped the competitive landscape of KONIVRER. Their
            achievements inspire future generations.
          </p>
        </div>
        ...
        <div className="mt-12 bg-gradient-to-r from-purple-500/20 to-blue-500/20 rounded-xl p-8 border border-purple-500/30">
          <div className="text-center">
            ...
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
              Know a player who deserves recognition for their contributions to
              competitive KONIVRER? The community can nominate players for Hall
              of Fame consideration based on their achievements, sportsmanship,
