...
import { Book, Globe, Users, Scroll, Star, Calendar, Eye, Heart, Share2 } from 'lucide-react';
    ...
    stories: [
      {
        ...
        likes: 234,
        views: 1520,
        excerpt: "In the depths of the ancient forests, a darkness stirs that threatens to consume all of Aethermoor. Follow the journey of our heroes as they discover the truth behind the Shadow Realm's emergence.",
...
This was the beginning of the end, or perhaps, the beginning of something far worse.`
      },
      {
        ...
        likes: 189,
        views: 987,
        excerpt: "Delve into the ancient conflicts that shaped the world of KONIVRER, where elemental forces clashed in battles that would determine the fate of all existence.",
        content: "The Elemental Wars began not with armies or declarations, but with a single drop of corrupted water..."
      },
      {
        id: 3,
        ...
        likes: 312,
        views: 2103,
        excerpt: "Ancient prophecies speak of a time when the last dragon will awaken, bringing either salvation or destruction to the realm. That time may be closer than we think.",
        content: "In the tongue of the ancients, it was written: 'When shadow meets light at the world's end...'"
      }
    ],
    worldGuide: [
      {
        ...
        type: "Location",
        description: "The primary realm where most KONIVRER adventures take place, a world of magic and mystery.",
        details: "Aethermoor is a vast continent divided into several distinct regions, each with its own unique characteristics and inhabitants."
      },
      {
        id: 2,
        title: "The Elemental Crystals",
        type: "Artifact",
        description: "Ancient crystals that contain the pure essence of the elemental forces.",
        details: "These crystals are the source of all elemental magic in the world, carefully guarded by the Elemental Orders."
      },
      {
        id: 3,
        title: "The Shadow Realm",
        type: "Dimension",
        description: "A parallel dimension of darkness and corruption that threatens to consume all reality.",
        details: "The Shadow Realm exists as a twisted mirror of our world, where light cannot penetrate and hope withers."
      }
    ],
    characters: [
      {
        ...
        race: "Elf",
        class: "Shadow Ranger",
        description: "A mysterious elven ranger who walks the line between light and shadow.",
        background: "Born in the Whisperwood Forest, Lyra has dedicated her life to protecting the natural balance."
      },
      {
        id: 2,
        ...
        description: "Master craftsman who can forge weapons imbued with elemental power.",
        background: "Heir to an ancient line of smiths, Thane discovered the secret of elemental forging."
      },
      {
        id: 3,
        ...
        race: "Human",
        class: "Storm Mage",
        description: "A powerful mage who commands the fury of storms and lightning.",
        background: "Trained in the Tower of Storms, Zara seeks to master the most volatile of elements."
      }
    ]
  };
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {loreData.characters.map(character => (
        ...
        >
          ...
          <p className="text-gray-300 mb-3 text-center">{character.description}</p>
          ...
          <article className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-8 border border-gray-700">
            <header className="mb-8">
              <div className="flex items-center space-x-2 mb-4">
                {selectedStory.featured && <Star className="w-5 h-5 text-yellow-400" />}
                <span className="bg-purple-500/20 text-purple-300 px-3 py-1 rounded-full text-sm">
              ...
              <div className="flex justify-between items-center text-gray-400 mb-6">
                <div>
                  ...
                  <p>{new Date(selectedStory.date).toLocaleDateString()} • {selectedStory.readTime} read</p>
                </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-white mb-4">World of KONIVRER</h1>
          <p className="text-gray-300 text-lg max-w-2xl mx-auto">
            Immerse yourself in the rich lore and captivating stories of the KONIVRER universe. 
            Discover the heroes, villains, and epic tales that shape this magical realm.
          </p>
        </div>
        ...
        <div className="mt-12 bg-gradient-to-r from-purple-500/20 to-blue-500/20 rounded-xl p-8 border border-purple-500/30">
          <div className="text-center">
            ...
            <h3 className="text-2xl font-bold text-white mb-4">Contribute to the Lore</h3>
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
              Have an idea for a story or character? The KONIVRER community welcomes creative contributions 
              to expand our shared universe. Submit your stories and become part of the legend.
            </p>
