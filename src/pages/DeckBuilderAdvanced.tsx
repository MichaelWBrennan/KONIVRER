...
export const DeckBuilderAdvanced: React.FC : any : any : any : any = () => {
  const [decks, setDecks] : any : any : any : any = useState<Deck[]>([]);
  const [selectedDeck, setSelectedDeck] : any : any : any : any = useState<Deck | null>(null);
  ...
  const createNewDeck : any : any : any : any = () => {
    const newDeck: Deck : any : any : any : any = {
            ...
            <div className={s.editor}>
              <div className={s.editorHeader}>
                <input
                  ...
                  onChange={(e) => {
                    const updatedDeck : any : any : any : any = { ...selectedDeck, name: e.target.value };
