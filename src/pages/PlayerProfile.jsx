...
const PlayerProfile = () => {
    ...
    const mockPlayer = {
      ...
      achievements: [
        ...
        },
        {
          ...
          description: 'Win with all element types',
          icon: '⚡',
          unlocked: true,
          date: '2023-08-15',
        },
  ...
  const getPlacementColor = placement => {
    ...
    if (placement.includes('2nd') || placement.includes('3rd'))
            ...
            <div className="mb-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-sm text-muted">
                  {player.xp}/{player.xp + player.xpToNext} XP
                </span>
              </div>
              <div className="w-full bg-tertiary rounded-full h-2">
                <div
                  ...
                  style={{
                    width: `${(player.xp / (player.xp + player.xpToNext)) * 100}%`,
                  }}
                ></div>
              </div>
            </div>
            ...
            <div key={match.id} className="card">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div
                    className={`text-lg font-bold ${getResultColor(match.result)}`}
                  >
            ...
            <div key={tournament.id} className="card">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  <div
                    className={`text-lg font-bold ${getPlacementColor(tournament.placement)}`}
                  >
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  <div className="text-sm text-muted mb-1">
                    Last played:{' '}
                    {new Date(deck.lastPlayed).toLocaleDateString()}
                  </div>
