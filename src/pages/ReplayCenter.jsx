...
const ReplayCenter = () => {
  ...
  const replays = [
    {
      ...
      gameData: {
        turns: [
          {
            turn: 1,
            player: 'Elena Vasquez',
            action: 'Play Lightning Sprite',
            life: [20, 20],
          },
          {
            turn: 1,
          ...
          },
          {
            turn: 2,
            player: 'Elena Vasquez',
            action: 'Attack with Lightning Sprite',
            life: [20, 18],
          },
          {
            turn: 2,
            player: 'David Kim',
            action: 'Play Elemental Warrior',
            life: [20, 18],
          },
          // ... more turns
        ],
  ...
  const filteredReplays = replays.filter(replay => {
    ...
    const matchesFormat =
      filters.format === 'all' || replay.format === filters.format;
            ...
            {selectedReplay ? (
                      ...
                      <div className="grid grid-cols-2 gap-8 mb-6">
                        <div className="text-center">
                          <div className="bg-blue-600 rounded-lg p-4 mb-2">
                            <h4 className="font-semibold">
                              {selectedReplay.players[0]}
                            </h4>
                            <p className="text-sm opacity-75">
                              {selectedReplay.heroes[0]}
                            </p>
                          </div>
                        ...
                        <div className="text-center">
                          <div className="bg-red-600 rounded-lg p-4 mb-2">
                            <h4 className="font-semibold">
                              {selectedReplay.players[1]}
                            </h4>
                            <p className="text-sm opacity-75">
                              {selectedReplay.heroes[1]}
                            </p>
                          </div>
                  ...
                  <div className="p-4 bg-gray-900/50">
                    ...
                    <div className="w-full bg-gray-700 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${((currentTurn + 1) / selectedReplay.turns) * 100}%`,
                        }}
                      />
                    </div>
                  </div>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <div className="text-center">
                        <div className="text-2xl font-bold text-blue-400">
                          {selectedReplay.views.toLocaleString()}
                        </div>
                        <div className="text-xs text-gray-400">Views</div>
                      </div>
                      <div className="text-center">
                        <div className="text-2xl font-bold text-red-400">
                          {selectedReplay.likes}
                        </div>
                        <div className="text-xs text-gray-400">Likes</div>
                      </div>
                      <div className="text-center">
                        <div className="text-2xl font-bold text-green-400">
                          {selectedReplay.comments}
                        </div>
              ...
              <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700 p-12 text-center">
                ...
                <p className="text-gray-400">
                  Choose a replay from the list to start watching
                </p>
              </div>
            )}
          </div>
