      ...
      <div className="bg-white border-b"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"></div>
          <div className="flex space-x-1 overflow-x-auto"></div>
            ...
            >
              <div className="flex items-center space-x-2"></div>
                <BarChart className="w-4 h-4" /></BarChart>
                <span>Stats</span>
              </div>
            </button>
            <button
                      ...
                      ></motion>
                        ...
                        <div className="mt-4 space-y-3"></div>
                          <div className="flex items-center justify-between"></div>
                            <div className="flex items-center space-x-2"></div>
                              <Laptop className="w-4 h-4 text-gray-500" /></Laptop>
                          ...
                          <div className="flex items-center justify-between"></div>
                            <div className="flex items-center space-x-2"></div>
                              <Headphones className="w-4 h-4 text-gray-500" /></Headphones>
                              <span className="text-sm text-gray-700"></span>
                                Voice Chat
                              </span>
                            </div>
                          ...
                          <div className="flex items-center justify-between"></div>
                            <div className="flex items-center space-x-2"></div>
                              <Trophy className="w-4 h-4 text-gray-500" /></Trophy>
                              <span className="text-sm text-gray-700"></span>
                                Show Rank
                              </span>
                            </div>
                      ...
                      <div className="flex justify-between items-start mb-3"></div>
                        <div></div>
                          <div className="flex items-center space-x-2 text-sm text-gray-500 mt-1"></div>
                            <div className="flex items-center space-x-1"></div>
                              <Shield className="w-4 h-4 text-blue-500" /></Shield>
                  ...
                  <div className="bg-blue-50 rounded-lg p-4"></div>
                    <div className="space-y-2 text-sm text-blue-800"></div>
                      ...
                      <div className="grid grid-cols-3 gap-2 mt-2"></div>
                        <div className="text-center"></div>
                          <Smartphone className="w-6 h-6 mx-auto mb-1" /></Smartphone>
                          <p className="text-xs">iOS/Android</p>
                        </div>
                        <div className="text-center"></div>
                          <Tablet className="w-6 h-6 mx-auto mb-1" /></Tablet>
                          <p className="text-xs">Tablets</p>
                        </div>
                        <div className="text-center"></div>
                          <Laptop className="w-6 h-6 mx-auto mb-1" /></Laptop>
                    ...
                    <div className="bg-green-50 rounded-lg p-4"></div>
                      <ul className="space-y-1 text-sm text-green-800"></ul>
                        <li className="flex items-center space-x-2"></li>
                          <CheckCircle className="w-4 h-4 flex-shrink-0" /></CheckCircle>
