...
import { Book, FileText, Scale, AlertTriangle, Download, Search, Calendar, ExternalLink } from 'lucide-react';
...
const RulesCenter = () => {
  ...
  const recentUpdates = [
    ...
    },
    {
      ...
      description: "Updated deck registration procedures and time limit adjustments.",
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-white mb-4">Rules & Policy Center</h1>
          <p className="text-gray-300 text-lg max-w-2xl mx-auto">
            Your comprehensive resource for KONIVRER rules, tournament policies, and official guidelines. 
            Stay up to date with the latest rule changes and tournament procedures.
          </p>
        </div>
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-8 border border-gray-700">
              ...
              <div className="flex justify-between items-start mb-6">
                <div>
                  ...
                  <p className="text-gray-300 mb-4">{currentSection.description}</p>
              ...
              <div className="space-y-4">
                ...
                {currentSection.sections.map(section => (
                  <div key={section.id} className="border border-gray-700 rounded-lg p-4 hover:border-purple-500 transition-colors">
                    <h4 className="text-lg font-semibold text-white mb-2">{section.title}</h4>
                    <ul className="space-y-1">
                      {section.subsections.map((subsection, index) => (
                        <li key={index} className="text-gray-300 hover:text-purple-400 cursor-pointer transition-colors">
                          {subsection}
                        </li>
                      ))}
                    </ul>
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-4">
                {recentUpdates.map((update, index) => (
                  <div key={index} className="border-l-4 border-purple-500 pl-4">
                    ...
                    <h4 className="text-white font-semibold mb-1">{update.title}</h4>
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
              ...
              <p className="text-gray-300 text-sm mb-4">
                Have questions about the rules or need clarification on a specific interaction?
              </p>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-gray-300 text-sm">
                These rules are the official and authoritative source for KONIVRER gameplay. 
                In case of conflicts between different versions, the most recent version takes precedence. 
                Tournament organizers and judges should always refer to the latest official documents.
              </p>
            </div>
          </div>
        </div>
