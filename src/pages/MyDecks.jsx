            ...
            {filteredAndSortedDecks.map(deck => (
              <div key={deck.id} className="card hover:border-accent-primary transition-all group">
                ...
                <div className="flex items-center gap-2 mb-3">
                  {deck.elements.map((element, idx) => (
                    <span key={idx} className="text-xl">{element}</span>
                  ))}
                </div>
                ...
                <div className="grid grid-cols-3 gap-4 mb-4 text-sm">
                  ...
                  <div className="text-center">
                    <div className="font-semibold">{deck.wins}-{deck.losses}</div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4 flex-1">
                    ...
                    <div className="flex items-center gap-6 text-sm">
                      ...
                      <span>{deck.wins}-{deck.losses} ({deck.winRate}%)</span>
