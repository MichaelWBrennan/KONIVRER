  ...
  const [decks] = useState([
    {
      ...
      description:
        'A fast-paced deck focusing on fire and earth synergies for quick victories.',
      cardCount: 40,
      isPublic: true,
    ...
    },
    {
      ...
      name: 'Water Control',
      description:
        'Control the battlefield with water spells and defensive creatures.',
      cardCount: 40,
      isPublic: false,
    ...
    },
    {
      ...
      description:
        'A balanced deck utilizing all four elements for versatile gameplay.',
      cardCount: 38,
      isPublic: true,
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6 gap-4">
          <div>
            ...
            <p className="text-secondary">
              Manage your deck collection ({decks.length} decks)
            </p>
          </div>
        ...
        {viewMode === 'grid' ? (
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredAndSortedDecks.map(deck => (
              <div
                key={deck.id}
                className="card hover:border-accent-primary transition-all group"
              >
          ...
          <div className="space-y-3">
            {filteredAndSortedDecks.map(deck => (
              <div
                key={deck.id}
                className="card hover:border-accent-primary transition-all"
              >
