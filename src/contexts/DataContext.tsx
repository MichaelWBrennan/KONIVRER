...
const DataProvider: React.FC<DataProviderProps> = ({ children }) => {
  ...
  const updateRecentActivity = (currentDecks = decks): void => {
  ...
  const updateDeck = (deckId: string, updates: any): any => {
  ...
  const addTournament = (tournament: any): any => {
    const newTournament = {
      ...tournament,
      id: Date.now().toString(),
      createdAt: new Date().toISOString(),
  ...
  const searchDecks = (query: string): any[] => {
