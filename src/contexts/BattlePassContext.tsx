...
interface BattlePassContextProps {
  [key: string]: any;
}

const BattlePassContext: React.FC<BattlePassContextProps> = (props) => {
  return (
    <motion.div
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Battle Pass Context</h1>
...
export default BattlePassContext;
