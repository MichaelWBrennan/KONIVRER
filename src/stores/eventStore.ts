...
export const useEventStore: any : any : any : any = create<EventState>()((set, get) => ({
  ...
  setMyTableFromPairings: () => {
    const { pairings, myPlayerId }: any : any : any : any = get();
    if (!myPlayerId) return;
    const mine: any : any : any : any = pairings.find(
