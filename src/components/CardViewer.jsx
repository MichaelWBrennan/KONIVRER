          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  {card.elements.map((element, idx) => (
                    <span key={idx} className="text-2xl">{element}</span>
                  ))}
                </div>
              </div>
              ...
              <div>
                ...
                <span className={`px-3 py-1 rounded text-sm font-medium ${getRarityColor(card.rarity)}`}>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {card.keywords.map((keyword, idx) => (
                      <span key={idx} className="px-2 py-1 bg-tertiary rounded text-sm">
                        {keyword}
                      </span>
                    ))}
                  </div>
