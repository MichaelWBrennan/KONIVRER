...
import { Zap, Shield, Sword, Info, X, Sparkles, Eye, Maximize2 } from 'lucide-react';
  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        animate={{ opacity: 1, scale: expanded ? 1.5 : 1, y: expanded ? -50 : 0 }}
      ...
      >
        ...
        <motion.div
          ...
          style={{
            ...
            transform: expanded ? `rotateX(${rotation.x}deg) rotateY(${rotation.y}deg)` : "none",
              ...
              {card.abilities && card.abilities.length > 0 && (
                <div className="mb-2">
                  {card.abilities.map((ability, index) => (
                    <div key={index} className="text-gray-200 text-xs mb-1 leading-relaxed">
            ...
            >
              ...
              <div className="space-y-2 text-sm">
                ...
                <div>
                  ...
                  <span className="text-white ml-2">{card.rarity || 'Common'}</span>
                </div>
                ...
                {card.type === 'Familiar' && (
                  <div className="pt-2 border-t border-gray-700">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-blue-400 font-bold">{card.toughness}</span>
                    </div>
                  </div>
                )}
                ...
                {card.azothCost && (
                  <div className="pt-2 border-t border-gray-700">
                    <div className="flex justify-between">
                      ...
                      <span className="text-yellow-400 font-bold">{card.azothCost}</span>
                    </div>
                  </div>
                )}
                ...
                {card.isPremium && (
                  <div className="mt-3 flex items-center justify-center bg-gradient-to-r from-purple-900/50 to-blue-900/50 p-2 rounded-md">
                    ...
                    <span className="text-purple-300 font-medium">Premium Card</span>
                  </div>
                )}
              </div>
            </motion.div>
