...
const UnifiedGameControls: React.FC<UnifiedGameControlsProps> = ({
  ...
  const renderControls = () => {
    ...
    case 'konivrer':
        return (
          <div className="konivrer-controls" /></div>
            {/* Phase indicators */
  }`
            <div className="phase-indicators" /></div>``
              <button ```
    ...
    <span>Start</span>
              ...
              <ChevronRight size={16} className="phase-arrow"  / /></ChevronRight>``
              <button ```
    ...
    default:
        return (
          <div className="standard-controls" /></div>
            {/* Phase display */
  }
  ...
  ``
  return (```
    <div className={`unified-game-controls ${variant} ${className}`} /></div>
      {renderControls()}
      `
      {/* Timer */}``
