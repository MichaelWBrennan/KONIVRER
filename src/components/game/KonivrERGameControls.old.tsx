...
const KonivrERGameControls: React.FC<KonivrERGameControlsProps> = ({
  ...
  const [azothSpent, setAzothSpent] = useState(false)
  const [selectedAbility, setSelectedAbility] = useState(false)
  const [tributeTargets, setTributeTargets] = useState(false)
...
``
export default KonivrERGameControls;`` : null`