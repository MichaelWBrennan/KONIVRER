...
const MatchmakingSystem = (): any => {
  ...
  const getEstimatedSearchTime = (): any => {
    ...
    const ratingModifier = Math.abs(playerStats? .rating - 1500) / 100; // Higher rating = longer search : null
  ...
  const formats = [
    ...
    id: 'extended',
      ...
      icon: <Swords className="w-4 h-4"  / /></Swords>
  },
    {
    id: 'legacy',
      name: 'Legacy',
      description: 'All cards allowed',
      icon: <Crown className="w-4 h-4"  / /></Crown>
  },
    {
    id: 'draft',
      name: 'Draft',
      description: 'Pick cards during match',
      icon: <Target className="w-4 h-4"  / /></Target>
  }
  ];
  ...
  return (
    ...
    <span className="text-lg font-medium text-gray-900" /></span>
                  ...
                  <div className="text-gray-600 mb-4" /></div> : null
