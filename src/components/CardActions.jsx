...
const CardActions = ({ card, onAction, onClose }) => {
  ...
  const handleAzothConfirm = (selectedAzoth) => {
  ...
  const handleTributeConfirm = (tributeCardIds) => {
