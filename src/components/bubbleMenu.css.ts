...
export const bubbleBtn = style({
  ...
  background: 'radial-gradient(100% 100% at 50% 0%, rgba(255,255,255,0.15) 0%, rgba(255,255,255,0.05) 40%, rgba(255,255,255,0.02) 100%), var(--accent-color)',
  color: 'white',
  fontSize: 20,
  cursor: 'pointer',
  transition: 'transform 0.12s ease, box-shadow 0.2s ease, background 0.2s ease',
  boxShadow: '0 10px 30px rgba(0,0,0,0.35), 0 0 0 1px rgba(255,255,255,0.05) inset, 0 8px 18px rgba(74,144,226,0.25)',
  display: 'flex',
  alignItems: 'center',
  ...
  userSelect: 'none',
  selectors: {
    '&:hover': { boxShadow: '0 12px 34px rgba(0,0,0,0.4), 0 10px 22px rgba(74,144,226,0.35)', transform: 'translateY(-2px)' },
...
export const panelCloseBtn = style({ position: 'absolute', top: 8, right: 8, background: 'transparent', border: 'none', color: 'var(--text-primary)', fontSize: 16, cursor: 'pointer', padding: 4, borderRadius: 6, lineHeight: '1', width: 28, height: 28, display: 'flex', alignItems: 'center', justifyContent: 'center', selectors: { '&:hover': { background: 'rgba(255,255,255,0.06)' } } });

export const settingGroup = style({ marginBottom: 16 });
export const menuNav = style({ display: 'flex', flexDirection: 'column', gap: 4 });
export const menuItem = style({ display: 'flex', alignItems: 'center', gap: 12, padding: '12px 16px', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 10, background: 'rgba(255,255,255,0.02)', color: 'var(--text-primary)', textAlign: 'left', cursor: 'pointer', transition: 'all 0.2s ease', fontSize: 16, width: '100%', selectors: { '&:hover': { background: 'rgba(255,255,255,0.05)' } } });
export const menuItemActive = style({ background: 'var(--accent-color)', color: 'white', borderColor: 'transparent', boxShadow: '0 6px 20px rgba(74,144,226,0.35)' });
