...
export const mobile: any : any : any : any = style({
...
export const desktop: any : any : any : any = style({ top: 20, right: 20 });
export const bubbleContainer: any : any : any : any = style({
  position: "absolute",
  pointerEvents: "auto",
  contain: "layout style",
...
export const bubbleBtn: any : any : any : any = style({
  width: 56,
  height: 56,
  minWidth: 44,
  minHeight: 44,
...
export const accessibilityBtn: any : any : any : any = style({ background: "#059669" });
export const searchBtn: any : any : any : any = style({ background: "#3b82f6" });
export const loginBtn: any : any : any : any = style({ background: "#8b5cf6" });
export const menuBtn: any : any : any : any = style({ background: "#f97316" });

export const panel: any : any : any : any = style({
  position: "relative",
  background:
...
export const panelCloseBtn: any : any : any : any = style({
  position: "absolute",
  top: 8,
  right: 8,
...
export const settingGroup: any : any : any : any = style({ marginBottom: 16 });
export const menuNav: any : any : any : any = style({
  display: "flex",
  flexDirection: "column",
  gap: 4,
});
export const menuItem: any : any : any : any = style({
  display: "flex",
  alignItems: "center",
  gap: 12,
  padding: "12px 16px",
...
export const menuItemActive: any : any : any : any = style({
  background: "var(--accent-color)",
  color: "white",
  borderColor: "transparent",
  boxShadow: "0 6px 20px rgba(74,144,226,0.35)",
});
export const menuLabel: any : any : any : any = style({ fontWeight: 500 });

// User panel styles
export const userProfile: any : any : any : any = style({ textAlign: "center" });
export const userAvatarLarge: any : any : any : any = style({
  width: 80,
  height: 80,
  borderRadius: "50%",
  background: "var(--accent-color)",
...
export const userActions: any : any : any : any = style({
  display: "flex",
  gap: 10,
  justifyContent: "center",
});
