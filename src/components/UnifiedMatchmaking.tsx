...
const UnifiedMatchmaking: React.FC<UnifiedMatchmakingProps> = (props) => {
  return (
    <motion.div
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Unified Matchmaking</h1>
