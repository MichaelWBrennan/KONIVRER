...
export const JudgePortal: React.FC<JudgePortalProps> = ({ className }) => {
  ...
  const [activeTab, setActiveTab] = useState<
    "search" | "sections" | "keywords" | "phases"
  >("search");
    ...
    if (!searchQuery.trim()) {
      return (
        <div style={{ textAlign: "center", color: "#666", padding: "2rem" }}>
          ...
          <p>
            Try searching for: "deck construction", "combat", "azoth", "life
            cards"
          </p>
        </div>
      );
      ...
      {allRules.rules.map((rule) => (
        <div
          ...
          style={{
            ...
            borderRadius: "8px",
            backgroundColor:
              selectedSection === rule.section ? "#f0f8ff" : "#f9f9f9",
            cursor: "pointer",
          }}
          onClick={() =>
            setSelectedSection(
    ...
    >
      {Object.entries(keywordAbilities).map(([keyword, definition]) => (
        ...
        >
          ...
          <p style={{ margin: 0, lineHeight: "1.6" }}>{definition}</p>
        </div>
      ))}
    </div>
  );
        ...
        {[
          ...
          <button
            ...
            style={{
              ...
              backgroundColor:
                activeTab === tab.key ? "#f0f8ff" : "transparent",
