    ...
    <div className="match-quality-indicator">
        ...
        <div className="col-md-6">
          <div className="mb-3">
            <div className="d-flex align-items-center mb-1">
              ...
              <Badge 
                bg={getQualityColor(getQualityLevel(advancedQuality.skillCompatibility))}
                className="ms-2"
              >
            ...
            <ProgressBar 
              variant={getQualityColor(getQualityLevel(advancedQuality.skillCompatibility))} 
              now={advancedQuality.skillCompatibility * 100} 
            />
            <small className="text-muted">
              Rating difference: {Math.abs(player1.rating - player2.rating)} points
            </small>
          </div>
          ...
          <div className="mb-3">
            <div className="d-flex align-items-center mb-1">
              ...
              <Badge 
                bg={getQualityColor(getQualityLevel(advancedQuality.playstyleCompatibility))}
                className="ms-2"
              >
            ...
            <ProgressBar 
              variant={getQualityColor(getQualityLevel(advancedQuality.playstyleCompatibility))} 
              now={advancedQuality.playstyleCompatibility * 100} 
            />
            <small className="text-muted">
        ...
        <div className="col-md-6">
          <div className="mb-3">
            <div className="d-flex align-items-center mb-1">
              ...
              <Badge 
                bg={getQualityColor(getQualityLevel(advancedQuality.historyCompatibility))}
                className="ms-2"
              >
            ...
            <ProgressBar 
              variant={getQualityColor(getQualityLevel(advancedQuality.historyCompatibility))} 
              now={advancedQuality.historyCompatibility * 100} 
            />
            <small className="text-muted">
          ...
          <div className="mb-3">
            <div className="d-flex align-items-center mb-1">
              ...
              <Badge 
                bg={getQualityColor(getQualityLevel(advancedQuality.deckCompatibility))}
                className="ms-2"
              >
            ...
            <ProgressBar 
              variant={getQualityColor(getQualityLevel(advancedQuality.deckCompatibility))} 
      ...
      <div className="mt-2">
        <div className="d-flex align-items-center mb-1">
          ...
          <Badge 
            bg={advancedQuality.confidence >= 0.7 ? 'success' : 
                advancedQuality.confidence >= 0.4 ? 'warning' : 'danger'}
            className="ms-2"
          >
      ...
      {advancedQuality.timeWeightedPerformance && (
        <div className="mt-3">
          ...
          <small className="text-muted">
            ...
            <Badge 
              bg={advancedQuality.timeWeightedPerformance.player1Trend > 0 ? 'success' : 
                  advancedQuality.timeWeightedPerformance.player1Trend < 0 ? 'danger' : 'secondary'}
              className="ms-1 me-2"
            >
              {advancedQuality.timeWeightedPerformance.player1Trend > 0 ? 'Improving' : 
               advancedQuality.timeWeightedPerformance.player1Trend < 0 ? 'Declining' : 'Stable'}
            </Badge>
            
            {player2.name}'s recent performance:
            <Badge 
              bg={advancedQuality.timeWeightedPerformance.player2Trend > 0 ? 'success' : 
                  advancedQuality.timeWeightedPerformance.player2Trend < 0 ? 'danger' : 'secondary'}
              className="ms-1"
            >
              {advancedQuality.timeWeightedPerformance.player2Trend > 0 ? 'Improving' : 
               advancedQuality.timeWeightedPerformance.player2Trend < 0 ? 'Declining' : 'Stable'}
            </Badge>
          </small>
        </div>
      )}
