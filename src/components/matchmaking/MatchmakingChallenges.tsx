    ...
    return (
      <div className="bg-white rounded-xl shadow-sm p-4 relative"></div>
        ...
        <div className="text-center py-6 text-gray-500"></div>
          <Target className="w-12 h-12 mx-auto mb-2 text-gray-300" /></Target>
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm p-4 relative"></div>
      ...
      <div className="flex items-center space-x-2 mb-3"></div>
        <Target className="w-5 h-5 text-blue-600" /></Target>
          ...
          ></motion>
            <div className="flex justify-between items-start mb-1"></div>
              <div className="flex items-center space-x-2"></div>
                {challenge.completed ? (
                  <CheckCircle className="w-4 h-4 text-green-500 flex-shrink-0" /></CheckCircle>
                ) : (
                  <Target className="w-4 h-4 text-blue-500 flex-shrink-0" /></Target>
                )}
