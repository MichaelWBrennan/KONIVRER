...
import { Target, Award, Clock, ChevronRight, X, CheckCircle, AlertCircle } from 'lucide-react';

const MatchmakingChallenges = ({ challenges, onViewAll, onClose, maxItems = 3 }) => {
          ...
          >
            ...
            <div className="mb-2">
              <div className="flex items-center justify-between text-xs text-gray-500 mb-1">
                ...
                <span>{Math.min(100, Math.round((challenge.progress / challenge.total) * 100))}%</span>
              </div>
