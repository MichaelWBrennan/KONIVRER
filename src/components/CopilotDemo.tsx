    ...
    switch (action) {
      case 'advance_turn':
        setGameState(prev => ({
          ...
          turn: prev.turn + 1,
          phase:
            prev.turn + 1 <= 3 ? 'early' : prev.turn + 1 <= 7 ? 'mid' : 'late',
        }));
        break;
      case 'change_deck':
        setCurrentDeck({
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-gray-300 text-sm">
                Advanced decision-making with multi-criteria evaluation and
                confidence scoring
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300 text-sm">
                Continuous improvement through pattern recognition and outcome
                tracking
              </p>
            </div>
          </div>
