...
const RulesCenter = () => {
  ...
  const tournamentRulesData = {
    tournamentOverview: {
      ...
      content: "KONIVRER tournaments are competitive events where players test their deck-building skills and strategic gameplay against other Conjurers. These events follow standardized procedures to ensure fair, consistent, and enjoyable competition for all participants.\n\n1.1 Tournament Types and Classifications\n• Casual Events: Local store tournaments with relaxed enforcement and learning focus\n• Competitive Events: Regional qualifiers and championship series with strict rule enforcement\n• Professional Events: Premier tournaments with highest level of competition and prizes\n• Constructed Tournaments: Players bring pre-built 40-card decks meeting format requirements\n• Limited Draft: Players build decks from booster packs during the event in draft pods\n• Sealed Deck: Players build decks from a fixed pool of unopened booster product\n• Team Events: Multiple players compete as coordinated teams with shared strategies\n• Online Tournaments: Digital events conducted through official KONIVRER platforms\n\n1.2 Tournament Structure and Format\n• Swiss pairing system for preliminary rounds ensuring balanced competition\n• Number of Swiss rounds determined by total attendance using standard formulas\n• Single-elimination playoffs for top performers based on Swiss standings\n• Match format: Best of 3 games with optional sideboarding between games\n• Time limits: 50 minutes per match plus 5 additional turns after time expires\n• Playoff rounds may use different time limits based on tournament tier\n• Tiebreaker procedures determine final standings and advancement\n\n1.3 Participation Requirements and Eligibility\n• Valid player registration with tournament organizer required before event start\n• Government-issued photo identification when requested by tournament staff\n• Compliance with all tournament policies, procedures, and code of conduct\n• Players under suspension or disciplinary action prohibited from participation\n• Age verification required for youth divisions and restricted events\n• Deck registration and verification completed before tournament begins\n• Payment of entry fees and acknowledgment of tournament rules\n\n1.4 Tournament Roles and Responsibilities\n• Tournament Organizer: Overall event management, logistics, and final authority\n• Head Judge: Final authority on rules interpretations and penalty decisions\n• Floor Judges: Monitor matches, answer questions, and enforce tournament rules\n• Scorekeeper: Maintain pairings, standings, match results, and tournament data\n• Players: Compete fairly, follow rules, and maintain sportsmanlike conduct\n• Spectators: Observe silently without interfering in matches or providing assistance\n\n1.5 Tournament Tiers and Sanctioning\n• Local Events: Store-level tournaments with basic prize support\n• Regional Qualifiers: Multi-store events qualifying players for higher tiers\n• National Championships: Country-level premier events with significant prizes\n• World Championships: International competition featuring top players globally\n• Special Events: Promotional tournaments with unique formats or restrictions\n• All sanctioned events contribute to official player rankings and statistics",
      keywords: ["tournament", "competitive", "constructed", "draft", "sealed", "swiss", "elimination", "sanctioning", "tiers"]
    },
    deckRegistration: {
    ...
    tournamentOperations: {
      ...
      content: "7.1 Tournament Software\n• Official KONIVRER Tournament System (KTS) used for all sanctioned events\n• Automated Swiss pairing system ensures fair opponent distribution\n• Real-time standings and bracket updates available to players\n• Digital match result reporting with verification systems\n• Integration with player rating and ranking databases\n\n7.2 Registration and Check-In\n• Online pre-registration required for Championship events\n• On-site registration available for local tournaments when space permits\n• Valid photo identification required for all competitive events\n• Player eligibility verification through official database\n• Late registration cutoff enforced strictly per event guidelines\n\n7.3 Round Structure and Timing\n• Swiss rounds determined by attendance using standard formulas\n• Top cut elimination rounds for events with 8+ players\n• Round timer synchronized across all tournament areas\n• 5-minute warning and time-called announcements\n• Playoff bracket seeding based on Swiss standings\n\n7.4 Prize Structure and Distribution\n• Prize support provided based on tournament tier and attendance\n• Booster packs, promotional cards, and tournament supplies awarded\n• Championship Points awarded for competitive ranking system\n• Special recognition for top performers and sportsmanship\n• Prize distribution requires valid player identification\n\n7.5 Data Collection and Reporting\n• Match results recorded in official tournament database\n• Player performance statistics tracked for ranking purposes\n• Tournament reports submitted to sanctioning organization\n• Penalty tracking for repeat offense identification\n• Event feedback collection for continuous improvement",
      keywords: ["operations", "software", "registration", "prizes", "data", "technology"]
    }
  };
