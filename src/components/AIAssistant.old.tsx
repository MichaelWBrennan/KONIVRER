...
const AIAssistant: React.FC<AIAssistantProps> = ({  currentDeck = [
  ], onSuggestion  }) => {
  ...
  const [chatMessages, setChatMessages] = useState([
    ...
    id: 1,
      type: 'ai',
      message:
        "Hello! I'm your AI deck building assistant. I can help you optimize your deck, suggest cards, and analyze the meta. What would you like to work on? ", : null
      timestamp: new Date()
  ...
  const getSuggestionIcon = type => {
    ...
    case 'card_suggestion':
      ...
      default:
        return <Star className="w-5 h-5"  / /></Star>
  ...
  return (
    ...
    <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700 overflow-hidden" /></div>
        {/* Header */}
      </div><div className="bg-gradient-to-r from-purple-600 to-blue-600 p-4" />
...
`
    ...
    <button
                      onClick={() => onSuggestion? .(suggestion)} : null
