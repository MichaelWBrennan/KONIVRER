...
const NotificationCenter: React.FC = () => {
  ...
  const getEventBadge = (
    eventId?: string,
    eventData?: { eventName?: string; eventFormat?: string },
  ) => {
      ...
      {showPermissionPrompt && (
        ...
        >
          ...
          >
            ...
            <p
              style={{ margin: "0 0 1.5rem 0", color: "#666", lineHeight: 1.5 }}
            >
              Get notified when rounds start, registration is accepted, and
              seating assignments are made. Stay updated on your tournament
              progress!
            </p>
            <div
              style={{
            ...
            >
              <div
                style={{
                  ...
                  alignItems: "center",
                  marginBottom:
                    Object.keys(eventGroups).length > 1 ? "0.5rem" : 0,
                }}
              >
                ...
                >
                  <button
                    ...
                    style={{
                      ...
                      border: "1px solid #ddd",
                      backgroundColor:
                        selectedEventFilter === null ? "#667eea" : "#fff",
                  ...
                  {Object.entries(eventGroups).map(
                    ([eventId, notifications]) => {
                      ...
                      const eventName =
                        eventId === "general"
                          ? "General"
                          : notifications[0]?.data?.eventName ||
