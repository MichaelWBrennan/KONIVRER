  ...
  useEffect(() => {
    ...
    if (filters.format) {
      filteredDecks = filteredDecks.filter(
        deck => deck.format?.toLowerCase() === filters.format.toLowerCase(),
      );
    }
  ...
  const getFilteredDecks = () => {
    return decks
      .filter(deck => {
        ...
        if (filters.archetype && deck.archetype !== filters.archetype)
          return false;
        if (
          filters.minPlacement &&
          deck.placement > parseInt(filters.minPlacement)
        )
          return false;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          <div className="bg-gray-700 rounded-lg p-4">
            ...
            <div className="space-y-1 text-sm text-gray-300">
              <p>
                <strong>Event:</strong> {deck.tournament}
              </p>
              <p>
                <strong>Pilot:</strong> {deck.pilot}
              </p>
              <p>
                <strong>Placement:</strong> {getPlacementIcon(deck.placement)}
              </p>
              <p>
                <strong>Date:</strong>{' '}
          ...
          <div className="bg-gray-700 rounded-lg p-4">
            ...
            <div className="space-y-1 text-sm text-gray-300">
              <p>
                <strong>Win Rate:</strong> {deck.winRate}%
              </p>
              <p>
                <strong>Popularity:</strong> {deck.popularity}%
              </p>
              <p>
                <strong>Views:</strong> {deck.views}
              </p>
              <p>
                <strong>Votes:</strong> {deck.votes}
              </p>
            </div>
          </div>
          ...
          <div className="bg-gray-700 rounded-lg p-4">
            ...
            <div className="space-y-1 text-sm text-gray-300">
              ...
              <p>
                ...
                {deck.sideboard.reduce((sum, card) => sum + card.quantity, 0)}{' '}
                cards
              </p>
              <p>
                <strong>Unique Cards:</strong> {deck.cards.length}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gray-800 rounded-lg p-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          <input
            ...
            onChange={e =>
              setFilters(prev => ({ ...prev, minPlacement: e.target.value }))
            }
            className="bg-gray-700 text-white rounded px-3 py-2"
            min="1"
            max="32"
