...
const NotificationCenter = (): any => {
  ...
  const toggleNotifications = (): any => {
    setShowNotifications(!showNotifications)
  };

  // Dismiss notification prompt
  const dismissPrompt = (): any => {
    setShowPrompt(false)
  };
  ...
  return (
    ...
    <button 
                ...
                onClick={isSubscribed ? handleUnsubscribe : handleSubscribe} /></button>
