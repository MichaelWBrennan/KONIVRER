      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4"></div>
        <div className="bg-gray-800 rounded-lg p-4"></div>
          <div className="flex items-center gap-3"></div>
            <Package className="w-8 h-8 text-blue-400" /></Package>
            <div></div>
        ...
        <div className="bg-gray-800 rounded-lg p-4"></div>
          <div className="flex items-center gap-3"></div>
            <Power className="w-8 h-8 text-green-400" /></Power>
            <div></div>
        ...
        <div className="bg-gray-800 rounded-lg p-4"></div>
          <div className="flex items-center gap-3"></div>
            <Eye className="w-8 h-8 text-purple-400" /></Eye>
            <div></div>
      ...
      <div className="space-y-4"></div>
        {sets.length === 0 ? (
          <div className="text-center py-12"></div>
            <Package className="w-16 h-16 text-gray-600 mx-auto mb-4" /></Package>
                    ...
                    <div className="flex items-center gap-2"></div>
                      ...
                      >
                        {set.isActive ? (
                          ...
                          <PowerOff className="w-4 h-4" /></PowerOff>
                        )}
                      </button>
