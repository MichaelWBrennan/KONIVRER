  ...
  return (
    <>
      ...
      {gestureState.isGesturing && (
        <div className="fixed top-4 left-1/2 transform -translate-x-1/2 bg-black/75 text-white px-4 py-0 whitespace-nowrap rounded-lg z-50"></div>
      ...
      <div className="fixed top-4 right-4 bg-white/90 backdrop-blur-sm rounded-lg shadow-lg border border-gray-200 p-3 z-40"></div>
