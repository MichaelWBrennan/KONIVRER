...
const RuleTooltip: React.FC<RuleTooltipProps> = ({
  ...
  return (
    ...
    position === 'top'
                    ? 'top-full left-1/2 -translate-x-1/2 -mt-1 border-r border-b' : null
                    : position === 'bottom'
                      ? 'bottom-full left-1/2 -translate-x-1/2 -mb-1 border-l border-t' : null
                      : position === 'left'`
                        ? 'left-full top-1/2 -translate-y-1/2 -ml-1 border-t border-r'` : null`
