...
const EnhancedPhysicalMatchmaking = (): any => {
  ...
  return (
    ...
    <label className="block text-sm font-medium mb-1" /></label>
      ...
      <option key={match.id} value={match.id}  / /></option>
    ...
    <QRCodeGenerator
                ...
                includeData={showQRData}  / /></QRCodeGenerator>
            </div>
    </>
  )}
        </div>
        ...
        <div className="bg-gray-50 p-4 rounded-lg shadow" />
    <h2 className="text-xl font-semibold mb-3">Tournaments</h2> : null
...
export default EnhancedPhysicalMatchmaking; : null