...
const TournamentBracket = ({
    ...
    () => ({
      ...
      players: [
        ...
        },
        {
          ...
          wins: 1,
          losses: 1,
          avatar: '/images/avatars/player4.jpg',
        },
        {
          id: 'player-005',
          name: 'David Kim',
          ...
          wins: 0,
          losses: 1,
          avatar: '/images/avatars/player5.jpg',
        },
        {
          id: 'player-006',
          name: 'Emma Davis',
          ...
          wins: 0,
          losses: 1,
          avatar: '/images/avatars/player6.jpg',
        },
        {
          id: 'player-007',
          name: 'Michael Brown',
          ...
          wins: 0,
          losses: 1,
          avatar: '/images/avatars/player7.jpg',
        },
        {
          id: 'player-008',
          ...
          wins: 0,
          losses: 1,
          avatar: '/images/avatars/player8.jpg',
        },
      ],
      rounds: [
        {
  ...
  useEffect(() => {
    if (highlightedMatch && bracketRef.current) {
      const matchElement = bracketRef.current.querySelector(
        `[data-match-id="${highlightedMatch}"]`,
      );
                    ...
                    <div className="game-result">
                      {game.winner ? (
                        <>
                          Winner:{' '}
                          {
                            tournament.players.find(p => p.id === game.winner)
                              ?.name
                          }
                          {game.score && (
  ...
  const renderRound = useCallback(
    round => {
      ...
      return (
        <div
          className={`round ${isVisible ? 'visible' : 'hidden'}`}
          key={round.id}
        >
          <div className="round-header" onClick={() => toggleRound(round.id)}>
            <h3>{round.name}</h3>
            <div className="round-toggle">{isVisible ? '▼' : '►'}</div>
          </div>
  ...
  return (
    <div
      className={`tournament-bracket ${isAncientTheme ? 'ancient-theme' : ''} ${theme} ${layout}`}
    >
      <div className="bracket-header">
        ...
        <div className="tournament-info">
          ...
          <div className="tournament-format">Format: {tournament.format}</div>
        </div>
      ...
      <style jsx>{`
        ...
        @keyframes pulse {
          ...
          70% {
            box-shadow: 0 0 0 10px rgba(var(--color-warning-rgb), 0);
          }
          100% {
            box-shadow: 0 0 0 0 rgba(var(--color-warning-rgb), 0);
          }
        }
