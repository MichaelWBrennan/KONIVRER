...
const DeckArchetypeAnalysis = ({
  ...
  const sampleDeckData = useMemo(() => [
    {
      ...
      cards: [
        { id: 'KON006', name: 'Lightning Bolt', count: 4, type: 'Spell', rarity: 'Common' },
        { id: 'KON012', name: 'Fire Elemental', count: 4, type: 'Creature', rarity: 'Uncommon' },
        { id: 'KON018', name: 'Volcanic Eruption', count: 2, type: 'Spell', rarity: 'Rare' },
        { id: 'KON024', name: 'Ember Mage', count: 4, type: 'Creature', rarity: 'Uncommon' },
        { id: 'KON030', name: 'Flame Strike', count: 3, type: 'Spell', rarity: 'Uncommon' },
        { id: 'KON036', name: 'Mountain', count: 23, type: 'Land', rarity: 'Common' }
      ],
      stats: {
        matches: 120,
        wins: 72,
    ...
    },
    {
      ...
      cards: [
        { id: 'KON007', name: 'Counterspell', count: 4, type: 'Spell', rarity: 'Uncommon' },
        { id: 'KON013', name: 'Mystic Scholar', count: 3, type: 'Creature', rarity: 'Rare' },
        { id: 'KON019', name: 'Time Warp', count: 2, type: 'Spell', rarity: 'Mythic' },
        { id: 'KON025', name: 'Mind Control', count: 2, type: 'Spell', rarity: 'Rare' },
        { id: 'KON031', name: 'Divination', count: 4, type: 'Spell', rarity: 'Common' },
        { id: 'KON037', name: 'Island', count: 25, type: 'Land', rarity: 'Common' }
      ],
      stats: {
        matches: 150,
        wins: 90,
    ...
    },
    {
      ...
      cards: [
        { id: 'KON008', name: 'Giant Growth', count: 4, type: 'Spell', rarity: 'Common' },
        { id: 'KON014', name: 'Ancient Guardian', count: 3, type: 'Creature', rarity: 'Mythic' },
        { id: 'KON020', name: 'Verdant Force', count: 2, type: 'Creature', rarity: 'Rare' },
        { id: 'KON026', name: 'Elvish Mystic', count: 4, type: 'Creature', rarity: 'Common' },
        { id: 'KON032', name: 'Natural Order', count: 2, type: 'Spell', rarity: 'Rare' },
        { id: 'KON038', name: 'Forest', count: 25, type: 'Land', rarity: 'Common' }
      ],
      stats: {
        matches: 130,
        wins: 71,
    ...
    },
    {
      ...
      cards: [
        { id: 'KON009', name: 'Elvish Archdruid', count: 4, type: 'Creature', rarity: 'Rare' },
        { id: 'KON015', name: 'Glimpse of Nature', count: 4, type: 'Spell', rarity: 'Rare' },
        { id: 'KON021', name: 'Wirewood Symbiote', count: 4, type: 'Creature', rarity: 'Uncommon' },
        { id: 'KON027', name: 'Heritage Druid', count: 4, type: 'Creature', rarity: 'Uncommon' },
        { id: 'KON033', name: 'Craterhoof Behemoth', count: 1, type: 'Creature', rarity: 'Mythic' },
        { id: 'KON038', name: 'Forest', count: 23, type: 'Land', rarity: 'Common' }
      ],
      stats: {
        matches: 100,
        wins: 65,
    ...
    },
    {
      ...
      cards: [
        { id: 'KON010', name: 'Elite Vanguard', count: 4, type: 'Creature', rarity: 'Common' },
        { id: 'KON016', name: 'Honor of the Pure', count: 4, type: 'Spell', rarity: 'Rare' },
        { id: 'KON022', name: 'Knight of the White Orchid', count: 4, type: 'Creature', rarity: 'Rare' },
        { id: 'KON028', name: 'Path to Exile', count: 4, type: 'Spell', rarity: 'Uncommon' },
        { id: 'KON034', name: 'Brave the Elements', count: 3, type: 'Spell', rarity: 'Common' },
        { id: 'KON039', name: 'Plains', count: 21, type: 'Land', rarity: 'Common' }
      ],
      stats: {
        matches: 110,
        wins: 60,
    ...
    archetypes: [
      {
        ...
        winrate: 0.52,
        subArchetypes: [
          { name: 'Burn', metaShare: 0.12, previousMetaShare: 0.08, change: 0.04, winrate: 0.6 },
          { name: 'White Weenie', metaShare: 0.08, previousMetaShare: 0.09, change: -0.01, winrate: 0.545 },
          { name: 'Red Deck Wins', metaShare: 0.09, previousMetaShare: 0.1, change: -0.01, winrate: 0.48 },
          { name: 'Other Aggro', metaShare: 0.06, previousMetaShare: 0.05, change: 0.01, winrate: 0.5 }
        ]
      },
      {
        name: 'Control',
        ...
        winrate: 0.55,
        subArchetypes: [
          { name: 'Blue Control', metaShare: 0.1, previousMetaShare: 0.11, change: -0.01, winrate: 0.6 },
          { name: 'Azorius Control', metaShare: 0.08, previousMetaShare: 0.09, change: -0.01, winrate: 0.53 },
          { name: 'Black Control', metaShare: 0.05, previousMetaShare: 0.06, change: -0.01, winrate: 0.51 },
          { name: 'Other Control', metaShare: 0.02, previousMetaShare: 0.02, change: 0, winrate: 0.5 }
        ]
      },
      {
        name: 'Midrange',
        ...
        winrate: 0.54,
        subArchetypes: [
          { name: 'Green Stompy', metaShare: 0.09, previousMetaShare: 0.07, change: 0.02, winrate: 0.546 },
          { name: 'Jund Midrange', metaShare: 0.06, previousMetaShare: 0.06, change: 0, winrate: 0.55 },
          { name: 'Abzan Midrange', metaShare: 0.03, previousMetaShare: 0.03, change: 0, winrate: 0.52 },
          { name: 'Other Midrange', metaShare: 0.02, previousMetaShare: 0.02, change: 0, winrate: 0.53 }
        ]
      },
      {
        name: 'Combo',
        ...
        winrate: 0.58,
        subArchetypes: [
          { name: 'Elf Combo', metaShare: 0.07, previousMetaShare: 0.04, change: 0.03, winrate: 0.65 },
          { name: 'Storm Combo', metaShare: 0.04, previousMetaShare: 0.04, change: 0, winrate: 0.55 },
          { name: 'Reanimator', metaShare: 0.03, previousMetaShare: 0.03, change: 0, winrate: 0.52 },
          { name: 'Other Combo', metaShare: 0.01, previousMetaShare: 0.01, change: 0, winrate: 0.5 }
        ]
      },
      {
        name: 'Other',
        ...
        winrate: 0.45,
        subArchetypes: [
          { name: 'Rogue Decks', metaShare: 0.03, previousMetaShare: 0.06, change: -0.03, winrate: 0.47 },
          { name: 'Experimental', metaShare: 0.02, previousMetaShare: 0.04, change: -0.02, winrate: 0.42 }
        ]
      }
    ],
    topCards: [
      { id: 'KON006', name: 'Lightning Bolt', usage: 0.25, previousUsage: 0.22, change: 0.03, winrate: 0.55 },
      { id: 'KON007', name: 'Counterspell', usage: 0.2, previousUsage: 0.21, change: -0.01, winrate: 0.58 },
      { id: 'KON008', name: 'Giant Growth', usage: 0.18, previousUsage: 0.15, change: 0.03, winrate: 0.53 },
      { id: 'KON028', name: 'Path to Exile', usage: 0.17, previousUsage: 0.18, change: -0.01, winrate: 0.54 },
      { id: 'KON015', name: 'Glimpse of Nature', usage: 0.15, previousUsage: 0.1, change: 0.05, winrate: 0.62 }
    ],
    matchups: [
    ...
    const trendData = {
      ...
      datasets: meta.archetypes.map((archetype, index) => ({
        ...
        data: meta.trends.map(trend => {
          const archetypeData = trend.archetypes.find(a => a.name === archetype.name);
  ...
  const getArchetypeColor = useCallback((archetypeName, index, alpha = 1) => {
    ...
    return colors[archetypeName] || `rgba(${Math.floor(Math.random() * 255)}, ${Math.floor(Math.random() * 255)}, ${Math.floor(Math.random() * 255)}, ${alpha})`;
  }, []);
    ...
    if (activeTab === 'archetypes') {
      const filtered = meta.archetypes
        .filter(archetype => 
          ...
          archetype.subArchetypes.some(sub => sub.name.toLowerCase().includes(query))
        )
        .map(archetype => ({
          ...archetype,
          decks: decks.filter(deck => deck.archetype === archetype.name)
  ...
  const handleArchetypeClick = useCallback((archetype) => {
    setExpandedArchetype(prev => prev === archetype.name ? null : archetype.name);
  ...
  if (isLoading) {
    return (
      <div className={`deck-archetype-analysis ${isAncientTheme ? 'ancient-theme' : ''}`}>
  ...
  return (
    <div className={`deck-archetype-analysis ${isAncientTheme ? 'ancient-theme' : ''}`}>
                    ...
                    >
                      <div className="cell name">
                        <div 
                          ...
                          style={{ backgroundColor: getArchetypeColor(archetype.name, sortedArchetypes.indexOf(archetype)) }}
                        ></div>
                        <span>{archetype.name}</span>
                        <span className="expand-indicator">{expandedArchetype === archetype.name ? '▼' : '►'}</span>
                      </div>
                      ...
                      {showWinrates && (
                        <div className={`cell winrate ${getWinrateClass(archetype.winrate)}`}>
                          {formatPercentage(archetype.winrate)}
                        </div>
                      )}
                      
                      {showTrends && (
                        <div className={`cell change ${getChangeClass(archetype.change)}`}>
                          {archetype.change > 0 ? '+' : ''}{formatPercentage(archetype.change)}
                        </div>
                      )}
                    </div>
                        ...
                        <div className="sub-archetypes">
                          ...
                          <div className="sub-table">
                            <div className="sub-header">
                              ...
                              {showMetaPercentages && <div className="sub-cell popularity">Meta %</div>}
                              {showWinrates && <div className="sub-cell winrate">Winrate</div>}
                              {showTrends && <div className="sub-cell change">Change</div>}
                            </div>
                            
                            {archetype.subArchetypes.map(subArchetype => (
                              <div className="sub-row" key={subArchetype.name}>
                                <div className="sub-cell name">{subArchetype.name}</div>
                                {showMetaPercentages && (
                                ...
                                {showWinrates && (
                                  <div className={`sub-cell winrate ${getWinrateClass(subArchetype.winrate)}`}>
                                    {formatPercentage(subArchetype.winrate)}
                                  </div>
                                )}
                                {showTrends && (
                                  <div className={`sub-cell change ${getChangeClass(subArchetype.change)}`}>
                                    {subArchetype.change > 0 ? '+' : ''}{formatPercentage(subArchetype.change)}
                                  </div>
                                )}
                              </div>
                            ))}
                              ...
                              {archetype.decks
                                ...
                                .map(card => (
                                  <div className="card-item" key={card.id}>
                                    ...
                                    <div className="card-usage">{Math.round(card.decks / archetype.decks.length * 100)}% of decks</div>
                                  </div>
                                ))
                              }
                            </div>
                        ...
                        <div className="matchups">
                          ...
                          <div className="matchups-grid">
                            {meta.matchups
                              ...
                              .map((matchup, index) => {
                                const isArchetype1 = matchup.archetype1 === archetype.name;
                                const otherArchetype = isArchetype1 ? matchup.archetype2 : matchup.archetype1;
                                const winrate = isArchetype1 ? matchup.winrate : 1 - matchup.winrate;
                                
                                return (
                                  <div className="matchup-item" key={index}>
                                    <div className="matchup-vs">vs. {otherArchetype}</div>
                                    <div className={`matchup-winrate ${getWinrateClass(winrate)}`}>
              ...
              {sortedCards.length === 0 ? (
                ...
                sortedCards.map(card => (
                  <div key={card.id}>
                    ...
                    >
                      <div className="cell name">
                        <div className={`card-type-icon ${card.type.toLowerCase()}`}></div>
                        <span>{card.name}</span>
                        <span className="card-rarity">{card.rarity}</span>
                        <span className="expand-indicator">{expandedCard === card.id ? '▼' : '►'}</span>
                      </div>
                      ...
                      {showWinrates && (
                        <div className={`cell winrate ${getWinrateClass(card.winrate)}`}>
                          {formatPercentage(card.winrate)}
                        </div>
                      )}
                      
                      {showTrends && (
                        <div className={`cell change ${getChangeClass(card.change)}`}>
                        ...
                        <div className="card-archetypes">
                          ...
                          <div className="archetypes-grid">
                            {meta.archetypes.map(archetype => {
                              const archetypeDecks = decks.filter(deck => deck.archetype === archetype.name);
                              const decksWithCard = archetypeDecks.filter(deck => 
                                deck.cards.some(c => c.id === card.id)
                              );
                              const usage = decksWithCard.length / archetypeDecks.length;
                              
                              if (usage > 0) {
                                return (
                                  <div className="archetype-item" key={archetype.name}>
                                    <div className="archetype-name">{archetype.name}</div>
                                    <div className="archetype-usage">{formatPercentage(usage)}</div>
                                  </div>
                                );
                              }
                        ...
                        <div className="card-synergies">
                          ...
                          <div className="synergies-grid">
                            {decks
                              ...
                              .reduce((acc, c) => {
                                const existing = acc.find(item => item.id === c.id);
                                if (existing) {
                                ...
                                <div className="synergy-item" key={synergy.id}>
                                  ...
                                  <div className="synergy-strength">
                                    <div 
                                      ...
                                      style={{ width: `${Math.min(100, synergy.count * 5)}%` }}
                                    ></div>
                                  </div>
                                </div>
                              ))
          ...
          <div className="meta-tab">
            <div className="meta-overview">
              <div className="meta-stat">
                ...
                <div className="stat-value">{meta.totalMatches.toLocaleString()}</div>
              </div>
              
              <div className="meta-stat">
                <div className="stat-label">Total Decks</div>
                <div className="stat-value">{meta.totalDecks.toLocaleString()}</div>
              </div>
              
              <div className="meta-stat">
                <div className="stat-label">Top Archetype</div>
                <div className="stat-value">{meta.archetypes.sort((a, b) => b.metaShare - a.metaShare)[0].name}</div>
              </div>
              
              <div className="meta-stat">
                <div className="stat-label">Top Card</div>
                <div className="stat-value">{meta.topCards.sort((a, b) => b.usage - a.usage)[0].name}</div>
              </div>
            </div>
                  ...
                  <div className="pie-segments">
                    {meta.archetypes.map((archetype, index) => (
                      <div 
                        ...
                        style={{
                          backgroundColor: getArchetypeColor(archetype.name, index),
                    ...
                    {meta.archetypes.map((archetype, index) => (
                      <div className="legend-item" key={archetype.name}>
                        <div 
                          ...
                          style={{ backgroundColor: getArchetypeColor(archetype.name, index) }}
                        ></div>
                        <div className="legend-label">{archetype.name}</div>
                        <div className="legend-value">{formatPercentage(archetype.metaShare)}</div>
                      </div>
                    ))}
                  </div>
                </div>
                        ...
                        <tr key={archetype1.name}>
                          ...
                          {meta.archetypes.map(archetype2 => {
                            if (archetype1.name === archetype2.name) {
                              return <td key={archetype2.name} className="matchup-cell same">-</td>;
                            }
                            
                            const matchup = meta.matchups.find(m => 
                              (m.archetype1 === archetype1.name && m.archetype2 === archetype2.name) ||
                              (m.archetype1 === archetype2.name && m.archetype2 === archetype1.name)
                            );
                            
                            if (!matchup) {
                              return <td key={archetype2.name} className="matchup-cell">N/A</td>;
                            }
                            
                            const winrate = matchup.archetype1 === archetype1.name 
                              ? matchup.winrate 
                              : 1 - matchup.winrate;
                  ...
                  <div className="chart-lines">
                    {meta.trends.map((trend, index) => (
                      <div 
                        ...
                        style={{ left: `${index / (meta.trends.length - 1) * 100}%` }}
                      >
                  ...
                  <div className="chart-areas">
                    {meta.archetypes.map((archetype, archetypeIndex) => {
                      const points = meta.trends.map((trend, trendIndex) => {
                        const archetypeData = trend.archetypes.find(a => a.name === archetype.name);
                        const metaShare = archetypeData ? archetypeData.metaShare : 0;
                        const previousArchetypes = meta.archetypes.slice(0, archetypeIndex);
                        const previousMetaShare = trend.archetypes
                          .filter(a => previousArchetypes.some(pa => pa.name === a.name))
                      ...
                      const pathD = `M${points[0].x},${points[0].y2} ${points.map(p => `L${p.x},${p.y2}`).join(' ')} L${points[points.length - 1].x},${points[points.length - 1].y1} ${points.reverse().map(p => `L${p.x},${p.y1}`).join(' ')} Z`;
                      
                      return (
                        <svg key={archetype.name} className="chart-area" viewBox="0 0 100 100" preserveAspectRatio="none">
                          <path 
                            d={pathD}
                            fill={getArchetypeColor(archetype.name, archetypeIndex, 0.7)}
                          />
                        </svg>
                      );
                    })}
              ...
              <div className="highlights-grid">
                <div className="highlight-card">
                  ...
                  <div className="highlight-content">
                    {(() => {
                      const archetype = [...meta.archetypes].sort((a, b) => b.change - a.change)[0];
                      return (
                        <>
                ...
                <div className="highlight-card">
                  ...
                  <div className="highlight-content">
                    {(() => {
                      const archetype = [...meta.archetypes].sort((a, b) => a.change - b.change)[0];
                      return (
                        <>
                          <div className="highlight-name">{archetype.name}</div>
                ...
                <div className="highlight-card">
                  ...
                  <div className="highlight-content">
                    {(() => {
                      const archetype = [...meta.archetypes].sort((a, b) => b.winrate - a.winrate)[0];
                      return (
                        <>
                          <div className="highlight-name">{archetype.name}</div>
                          <div className={`highlight-value positive`}>
                ...
                <div className="highlight-card">
                  ...
                  <div className="highlight-content">
                    {(() => {
                      const card = [...meta.topCards].sort((a, b) => b.change - a.change)[0];
                      return (
                        <>
      ...
      <style jsx>{`
        ...
        .meta-format, .meta-time-range {
          display: flex;
          align-items: center;
          gap: 5px;
        }
        
        .meta-format select, .meta-time-range select {
          padding: 5px 10px;
          border-radius: 4px;
        ...
        .header-cell.popularity, .header-cell.winrate, .header-cell.change {
          flex: 1;
          text-align: center;
        ...
        .cell.popularity, .cell.winrate, .cell.change {
          flex: 1;
          justify-content: center;
        }
        ...
        .archetype-details, .card-details {
          padding: 15px;
          background-color: ${isAncientTheme ? '#3a3828' : '#f5f5f5'};
          border-bottom: 1px solid ${isAncientTheme ? '#3a3828' : '#f0f0f0'};
          display: grid;
        ...
        .sub-archetypes, .card-archetypes {
          grid-column: 1;
        }
        
        .popular-cards, .card-synergies {
          grid-column: 2;
        }
        ...
        .cards-grid, .archetypes-grid, .matchups-grid, .synergies-grid {
          display: grid;
        ...
        .card-item, .archetype-item, .matchup-item, .synergy-item {
          background-color: ${isAncientTheme ? '#2c2b20' : '#ffffff'};
          padding: 10px;
          border-radius: 8px;
          font-size: 0.9rem;
        ...
        .card-name, .archetype-name, .matchup-vs, .synergy-name {
          font-weight: bold;
          margin-bottom: 5px;
        }
        
        .card-usage, .archetype-usage {
          font-size: 0.8rem;
          color: ${isAncientTheme ? '#a89a6a' : '#666666'};
        }
        ...
        .matchup-matrix th, .matchup-matrix td {
          padding: 8px;
          text-align: center;
          border: 1px solid ${isAncientTheme ? '#3a3828' : '#f0f0f0'};
        }
        ...
        .chart-legend {
          ...
          top: 10px;
          right: 10px;
          background-color: ${isAncientTheme ? 'rgba(44, 43, 32, 0.8)' : 'rgba(255, 255, 255, 0.8)'};
          padding: 10px;
          border-radius: 8px;
          z-index: 2;
        }
        ...
        @media (max-width: 768px) {
          ...
          .sub-archetypes, .popular-cards, .card-archetypes, .card-synergies, .matchups {
            grid-column: 1;
          }
