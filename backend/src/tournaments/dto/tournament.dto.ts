import { IsString, IsOptional, IsEnum, IsArray, IsNumber, IsBoolean, ValidateNested, Min, Max, IsUUID, IsDateString, IsUrl } from 'class-validator';
...
export class TournamentSettingsDto {
  @ApiProperty({ description: 'Maximum number of players', minimum: 4, maximum: 1024 })
  @IsNumber()
  @Min(4)
  @Max(1024)
  maxPlayers: number;

  @ApiProperty({ description: 'Minimum number of players', minimum: 2, maximum: 512 })
  @IsNumber()
  @Min(2)
  @Max(512)
  minPlayers: number;
...
export class TournamentPrizingDto {
  ...
  @ApiProperty({ description: 'Prize distribution by place', type: [PrizeDistributionDto] })
  @IsArray()
...
export class CreateTournamentDto {
  ...
  @ApiPropertyOptional({ description: 'Tournament location (for in-person events)' })
  @IsOptional()
  @IsString()
  location?: string;
  ...
  @ApiProperty({ description: 'Tournament settings', type: TournamentSettingsDto })
  @ValidateNested()
  @Type(() => TournamentSettingsDto)
  settings: TournamentSettingsDto;

  @ApiPropertyOptional({ description: 'Prize structure', type: TournamentPrizingDto })
  @IsOptional()
  @ValidateNested()
...
export class UpdateTournamentDto {
  ...
  @ApiPropertyOptional({ enum: TournamentStatus, description: 'Tournament status' })
  @IsOptional()
  @IsEnum(TournamentStatus)
  status?: TournamentStatus;

  @ApiPropertyOptional({ enum: TournamentVisibility, description: 'Tournament visibility' })
  @IsOptional()
  @IsEnum(TournamentVisibility)
  visibility?: TournamentVisibility;
  ...
  @ApiPropertyOptional({ description: 'Tournament settings', type: TournamentSettingsDto })
  @IsOptional()
  @ValidateNested()
  @Type(() => TournamentSettingsDto)
  settings?: TournamentSettingsDto;
...
export class TournamentSearchFilters {
  ...
  @ApiPropertyOptional({ enum: TournamentFormat, description: 'Filter by format' })
  @IsOptional()
  @IsEnum(TournamentFormat)
  format?: TournamentFormat;
  ...
  @ApiPropertyOptional({ enum: TournamentStatus, description: 'Filter by status' })
  @IsOptional()
  @IsEnum(TournamentStatus)
  status?: TournamentStatus;
  ...
  @ApiPropertyOptional({ description: 'Filter tournaments starting after this date' })
  @IsOptional()
  @IsDateString()
  startDateFrom?: Date;

  @ApiPropertyOptional({ description: 'Filter tournaments starting before this date' })
  @IsOptional()
  @IsDateString()
  startDateTo?: Date;
  ...
  @ApiPropertyOptional({ description: 'Sort field', enum: ['startDate', 'createdAt', 'name', 'registeredPlayers'] })
  @IsOptional()
  @IsString()
  sortBy?: string;
