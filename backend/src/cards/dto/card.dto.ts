...
export class CreateCardDto {
  ...
  @ApiProperty({
    description: "Mana/Azoth cost (0-20)",
    minimum: 0,
    maximum: 20,
  })
  @IsInt()
  ...
  @ApiProperty({
    description: "Whether the card is tournament legal",
    required: false,
    default: true,
  })
  @IsOptional()
...
export class CardFilterDto {
  @ApiProperty({
    description: "Search query for name, description, keywords",
    required: false,
  })
  @IsOptional()
  @IsString()
  ...
  @ApiProperty({
    enum: CardElement,
    description: "Filter by card element",
    required: false,
  })
  @IsOptional()
  @IsEnum(CardElement)
  ...
  @ApiProperty({
    description: "Filter tournament legal cards only",
    required: false,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiProperty({
    ...
    required: false,
    enum: ["name", "cost", "power", "metaRating", "createdAt"],
    default: "name",
  })
  @IsOptional()
  @IsString()
