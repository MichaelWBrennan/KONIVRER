...
interface TemporaryEffect {
  ...
  sourceId: string;
  effect: string;
  duration: 'end_of_turn' | 'until_end_of_combat' | 'permanent' | 'until_leaves_battlefield';
  expiresAt?: Date;
}
...
export class Game {
  ...
  @Column({ nullable: true })
  @Field(() => ID, { nullable: true })
  @ApiProperty({ description: 'Associated tournament match ID', required: false })
  tournamentMatchId?: string;

  @Column({ type: 'simple-array', nullable: true })
  @Field(() => [String], { nullable: true })
  @ApiProperty({ description: 'Spectator user IDs', type: [String], required: false })
  spectators?: string[];
