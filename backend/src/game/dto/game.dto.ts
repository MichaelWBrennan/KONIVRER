import { IsString, IsOptional, IsEnum, IsArray, IsNumber, IsBoolean, ValidateNested, Min, Max, IsUUID } from 'class-validator';
import { Type, Transform } from 'class-transformer';
import { ApiProperty, ApiPropertyOptional } from '@nestjs/swagger';
import { GameFormat, GameType, TurnPhase } from '../entities/game.entity';

export class GameSettingsDto {
  @ApiProperty({ description: 'Time per player in minutes', minimum: 5, maximum: 120 })
  @IsNumber()
  @Min(5)
  @Max(120)
  ...
  @ApiPropertyOptional({ description: 'Show hands to all players (practice mode)' })
  @IsOptional()
  @IsBoolean()
  showHands?: boolean;
  ...
  @ApiPropertyOptional({ description: 'Maximum takebacks per player', minimum: 0, maximum: 10 })
  @IsOptional()
  @IsNumber()
  @Min(0)
  @Max(10)
...
export class CreateGameDto {
  ...
  @ApiPropertyOptional({ description: 'Player 2 user ID (for direct challenge)' })
  @IsOptional()
  @IsUUID()
  player2Id?: string;

  @ApiPropertyOptional({ description: 'Player 2 deck ID (for direct challenge)' })
  @IsOptional()
  @IsUUID()
  ...
  @ApiPropertyOptional({ description: 'Tournament match ID if this is a tournament game' })
  @IsOptional()
  @IsUUID()
...
export class GameSearchFilters {
  ...
  @ApiPropertyOptional({ description: 'Sort field', enum: ['createdAt', 'startedAt', 'duration'] })
  @IsOptional()
  @IsString()
  sortBy?: string;
