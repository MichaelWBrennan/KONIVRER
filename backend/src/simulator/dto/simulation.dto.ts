...
export class SimulationConfigDto {
  ...
  @ApiProperty({ description: 'Random seed for deterministic results', required: false })
  @IsOptional()
  @IsString()
  seed?: string;

  @ApiProperty({ description: 'Number of iterations to run', minimum: 1, maximum: 10000, default: 1000 })
  @IsNumber()
  @Min(1)
  @Max(10000)
  iterations: number;
