...
export class Event {
  ...
  @ApiProperty({ description: 'Event registrations', type: () => [EventRegistration], required: false })
  registrations?: EventRegistration[];

  @OneToMany(() => Pairing, (pairing) => pairing.event)
  @Field(() => [Pairing], { nullable: true })
  @ApiProperty({ description: 'Event pairings', type: () => [Pairing], required: false })
  pairings?: Pairing[];

  @OneToMany(() => Match, (match) => match.event)
  @Field(() => [Match], { nullable: true })
  @ApiProperty({ description: 'Event matches', type: () => [Match], required: false })
  matches?: Match[];

  @OneToMany(() => AuditLog, (log) => log.event)
  @Field(() => [AuditLog], { nullable: true })
  @ApiProperty({ description: 'Event audit logs', type: () => [AuditLog], required: false })
  auditLogs?: AuditLog[];
  ...
  get hasStarted(): boolean {
    return [EventStatus.IN_PROGRESS, EventStatus.COMPLETED].includes(this.status);
  }
...
export class EventRegistration {
  ...
  @Column('uuid', { nullable: true })
  @Field(() => ID, { nullable: true })
  @ApiProperty({ description: 'Deck ID (if deck list required)', required: false })
  deckId?: string;

  @Column({ type: 'jsonb', nullable: true })
  @Field({ nullable: true })
  @ApiProperty({ description: 'Additional registration metadata', required: false })
...
export class Pairing {
  ...
  @Column({ type: 'jsonb', nullable: true })
  @Field({ nullable: true })
  @ApiProperty({ description: 'Pairing metadata (match quality, etc.)', required: false })
  pairingMetadata?: Record<string, any>;

  @Column({ type: 'timestamp', nullable: true })
  @Field({ nullable: true })
  @ApiProperty({ description: 'When pairing was published to players', required: false })
  publishedAt?: Date;

  @OneToMany(() => Match, (match) => match.pairing)
  @Field(() => [Match], { nullable: true })
  @ApiProperty({ description: 'Matches for this pairing', type: () => [Match], required: false })
  matches?: Match[];
...
export class Match {
  ...
  @Field(() => String, { nullable: true })
  @ApiProperty({ enum: MatchResult, description: 'Player A result', required: false })
  ...
  @Field(() => String, { nullable: true })
  @ApiProperty({ enum: MatchResult, description: 'Player B result', required: false })
  ...
  @Column('uuid', { nullable: true })
  @Field(() => ID, { nullable: true })
  @ApiProperty({ description: 'Judge who confirmed the result', required: false })
  ...
  @ApiProperty({ description: 'Judge rulings for this match', type: () => [Judging], required: false })
  judgings?: Judging[];
...
export class Judging {
  ...
  @Column({ type: 'simple-array', nullable: true })
  @Field(() => [String], { nullable: true })
  @ApiProperty({ description: 'Attachment URLs (screenshots, etc.)', type: [String], required: false })
  attachments?: string[];
