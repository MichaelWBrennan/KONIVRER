...
export class EventSettingsDto {
  ...
  @Field(() => [String])
  @ApiProperty({ description: 'Tie-break rules in order of precedence', type: [String] })
  @IsArray()
  @ArrayMinSize(1)
  @IsString({ each: true })
...
export class GeneratePairingsDto {
  ...
  @Field(() => [[String]], { nullable: true })
  @ApiPropertyOptional({ description: 'Previous pairings to avoid', type: [[String]] })
  @IsOptional()
  @IsArray()
...
export class EventSearchFiltersDto {
  ...
  @Field({ nullable: true })
  @ApiPropertyOptional({ enum: PairingType, description: 'Filter by pairing type' })
  @IsOptional()
  @IsEnum(PairingType)
  pairingType?: PairingType;
...
export class PairingQualityDto {
  ...
  @ApiProperty({ description: 'Win probabilities for each player', type: [Number] })
