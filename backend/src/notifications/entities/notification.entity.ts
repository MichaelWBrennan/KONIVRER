...
export class Notification {
  ...
  @ApiProperty({ description: 'Error message if sending failed', required: false })
  errorMessage?: string;
  ...
  @ApiProperty({ description: 'User who receives this notification', type: () => User, required: false })
  user?: User;
