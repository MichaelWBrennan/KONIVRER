...
export default defineConfig({
  ...
  server: {
    ...
    cors: true,
    allowedHosts: [
      'work-1-wudyadwejoyiuwas.prod-runtime.all-hands.dev',
      'work-2-wudyadwejoyiuwas.prod-runtime.all-hands.dev',
      ...
      'work-2-qbftlrhmkqoatdem.prod-runtime.all-hands.dev',
      'work-1-qlzgoajlezyqcyjr.prod-runtime.all-hands.dev',
      'work-2-qlzgoajlezyqcyjr.prod-runtime.all-hands.dev',
      ...
      'work-1-gutrgnocbuoisfoo.prod-runtime.all-hands.dev',
      'work-2-gutrgnocbuoisfoo.prod-runtime.all-hands.dev',
      'work-1-nbckvikthaevvrpw.prod-runtime.all-hands.dev',
      'work-2-nbckvikthaevvrpw.prod-runtime.all-hands.dev',
      'work-1-rwdynyibquxfwnqy.prod-runtime.all-hands.dev',
      'work-2-rwdynyibquxfwnqy.prod-runtime.all-hands.dev',
      'work-1-elyrdikidgzbrgme.prod-runtime.all-hands.dev',
      'work-2-elyrdikidgzbrgme.prod-runtime.all-hands.dev',
      'work-1-ylhrwvivugtybqoj.prod-runtime.all-hands.dev',
      'work-2-ylhrwvivugtybqoj.prod-runtime.all-hands.dev',
      'work-1-rjlsubecyohnicnr.prod-runtime.all-hands.dev',
      'work-2-rjlsubecyohnicnr.prod-runtime.all-hands.dev',
      'work-1-okltlyjvfbnkrtcm.prod-runtime.all-hands.dev',
      'work-2-okltlyjvfbnkrtcm.prod-runtime.all-hands.dev',
      'work-1-yxcveojuzrsgtyep.prod-runtime.all-hands.dev',
      'work-2-yxcveojuzrsgtyep.prod-runtime.all-hands.dev',
      'work-1-hhatbducqjfgault.prod-runtime.all-hands.dev',
      ...
      'work-1-nwdcceuisfxzttjm.prod-runtime.all-hands.dev',
      'work-2-nwdcceuisfxzttjm.prod-runtime.all-hands.dev',
      'localhost',
      '127.0.0.1'
    ]
  },
